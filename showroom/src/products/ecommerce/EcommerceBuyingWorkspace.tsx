...
export function EcommerceBuyingWorkspace({
  ...
  // Keep an input draft so backspace-and-retype works without ever writing an invalid
  // quantity into the cart. Blur snaps the field back to the accepted 1-99 value.
