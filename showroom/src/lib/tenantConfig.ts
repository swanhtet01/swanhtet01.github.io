...
const defaultTenant: TenantConfig = {
  ...
  compactMark: 'SM',
  brandTagline: 'A free POS for Myanmar businesses',
  siteMode: 'platform',
  navItems: [
    { label: 'DeskPOS', to: '/products' },
    { label: 'Case Study', to: '/clients/yangon-tyre' },
    { label: 'Contact', to: '/contact' },
  ],
  showBookCta: true,
  bookCtaLabel: 'Try the live POS',
  homeEyebrow: 'DeskPOS by SUPERMEGA · Live now',
  homeTitle: 'A free POS that runs your spa, salon, retail, cafe, or repair desk.',
  homeDescription: 'MMK / KBZPay / MMQR / cash from day one. Runs on a tablet or PC, works offline. No monthly fee, no card-reader lock-in.',
  homePrimaryCta: { label: 'Try the live demo', to: '/products' },
