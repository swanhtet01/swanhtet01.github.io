...
const SITE_SCREENSHOT_LIBRARY = {
  ...
  yangonTyre: {
    ...
    alt: 'Factory Client client portal preview',
...
export const SOFTWARE_MODULE_DETAILS: SoftwareModuleDetail[] = [
  ...
  },
  {
    ...
    liveNotes: ['Case study: Factory Client', 'Plant quality workspace with CAPA and KPI review', 'Methods: Ishikawa, 5W1H, CAPA, KPI review'],
  ...
  },
  {
    ...
    deliveryState: 'Branded portal pattern proven through the Factory Client tenant model.',
    liveNotes: ['Public proof: Factory Client case study', 'Role-based workspace entry', 'Extends into supplier and external service rooms'],
  ...
  },
  {
    ...
    liveNotes: ['Case study base: Factory Client', 'Supplier discrepancy and evidence workspace', 'Built to move suppliers out of email-only loops'],
  ...
  },
  {
    ...
    liveNotes: ['Launches domains, roles, connectors, and rollout packs', 'Supports named client portals like Factory Client', 'Reusable control layer for new company workspaces'],
