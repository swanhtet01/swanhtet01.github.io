...
export const SUPERMEGA_CORE_MODEL: TenantOperatingModel = {
  ...
  modules: [
    ...
    },
    {
      ...
      category: 'Control',
      status: 'Control layer',
      summary: 'The enterprise control layer for strategy, architecture, infrastructure sequencing, delegated pods, and execution-track seeding.',
      users: ['platform admin', 'product owner', 'implementation lead'],
      route: '/app/workbench',
      dataFlows: ['execution tracks', 'program posture', 'runtime pressure', 'strategy decisions'],
      controls: ['delegated pod charters', 'phase sequencing', 'architecture decisions'],
    },
    {
    ...
    },
    {
      ...
      category: 'Control',
      status: 'Control layer',
      summary: 'The shared cloud operating layer for pod ownership, environment posture, internal tooling, and service-lane sequencing.',
      users: ['platform admin', 'director', 'implementation lead'],
      route: '/app/cloud',
      dataFlows: ['pod topology', 'environment map', 'internal tool registry', 'service-lane posture'],
      controls: ['cloud setup sequencing', 'environment ownership', 'operating rules'],
    },
    {
...
export const YANGON_TYRE_MODEL: TenantOperatingModel = {
  ...
  paradigmShifts: [
    ...
    'From one large ERP rollout to modular systems for sales, ops, quality, maintenance, manufacturing, and leadership.',
  ...
  modules: [
    ...
    },
    {
      ...
      category: 'Control',
      status: 'Live now',
      summary: 'A calm manager layer for daily review loops, industrial methods, training drills, and the next desk to open.',
      users: ['plant manager', 'quality manager', 'maintenance lead', 'director', 'tenant admin'],
      route: '/app/plant-manager',
      dataFlows: ['manager routines', 'training drills', 'role focus', 'cross-desk review flow'],
      controls: ['daily review standard work', 'method selection', 'teaching packs', 'route clarity'],
    },
    {
      id: 'supplier-control',
    ...
    {
      id: 'quality-closeout',
      name: 'DQMS and Quality Methods',
      category: 'ERP',
      status: 'Rollout ready',
      summary: 'Industrial DQMS for incidents, CAPA, KPI review, fishbone, 5W1H, containment, and closeout discipline.',
      users: ['quality manager', 'plant manager', 'maintenance lead'],
      route: '/app/dqms',
      dataFlows: ['incident reports', 'CAPA tasks', 'inspection evidence', 'root-cause notes', 'quality KPI drift'],
      controls: ['root cause trail', '5W1H structure', 'fishbone review', 'closeout gates', 'quality review'],
    },
    {
    ...
    },
    {
      ...
      category: 'ERP',
      status: 'Rollout ready',
      summary: 'Shift, line, and process control from mixing through extrusion, calendering, building, curing, and final inspection.',
      users: ['plant manager', 'quality manager', 'maintenance lead'],
      route: '/app/operations',
      dataFlows: ['line status', 'changeover loss', 'batch genealogy', 'process drift', 'shift attainment'],
      controls: ['recipe discipline', 'stage traceability', 'escalation rules', 'shift review'],
    },
    {
      id: 'lab-spc',
      name: 'Lab SPC and Release',
      category: 'ERP',
      status: 'Next module',
      summary: 'Compound release, lab SPC, component dimensions, cure validation, and final-release checks on one quality layer.',
      users: ['quality manager', 'plant manager'],
      route: '/app/dqms',
      dataFlows: ['lab tests', 'compound release', 'spec deviations', 'release decisions'],
      controls: ['test limits', 'release authority', 'batch containment', 'spec escalation'],
    },
    {
      id: 'inventory-pulse',
    ...
    },
    {
      ...
      category: 'Control',
      status: 'Control layer',
      summary: 'The control surface for strategy, infrastructure sequencing, delegated pods, and execution-track management.',
      users: ['tenant admin', 'director'],
      route: '/app/workbench',
      dataFlows: ['strategy decisions', 'execution tracks', 'runtime posture', 'release pressure'],
      controls: ['pod accountability', 'phase sequencing', 'promotion priorities', 'cross-module tradeoffs'],
    },
    {
      id: 'ai-app-foundry',
      name: 'AI App Foundry',
      category: 'Control',
      status: 'Rollout ready',
      summary: 'Designs each tenant app from operator jobs, SaaS benchmarks, shared records, agent crews, and release gates.',
      users: ['tenant admin', 'director'],
      route: '/app/factory',
      dataFlows: ['app briefs', 'ux contracts', 'workflow specs', 'release recommendations'],
      controls: ['app promotion', 'ux review', 'agent boundary review', 'duplicate-entry prevention'],
    },
    {
      id: 'adoption-playbook',
      name: 'Adoption and Data Discipline',
      category: 'Control',
      status: 'Rollout ready',
      summary: 'Role playbooks, mandatory entry rules, manager cadences, and adoption scorecards so the portal becomes the operating path.',
      users: ['tenant admin', 'director', 'plant manager', 'receiving clerk', 'procurement lead', 'quality manager', 'maintenance lead', 'sales lead'],
      route: '/app/adoption',
      dataFlows: ['entry completion', 'ritual completion', 'training gaps', 'insight freshness'],
      controls: ['required field discipline', 'same-day review', 'manager usage', 'role enablement'],
    },
    {
      id: 'adoption-command',
      ...
      category: 'Control',
      status: 'Rollout ready',
      summary: 'Scores role usage, writeback health, manager rituals, and agent reinforcement so the portal becomes the actual operating system.',
      users: ['tenant admin', 'director', 'plant manager', 'receiving clerk', 'procurement lead', 'quality manager', 'maintenance lead', 'sales lead'],
      route: '/app/adoption-command',
      dataFlows: ['role scores', 'writeback freshness', 'ritual drift', 'agent reinforcement'],
      controls: ['role-score review', 'writeback intervention', 'manager ritual enforcement', 'autonomous follow-through'],
    },
    {
      id: 'workforce-command',
      name: 'Workforce Command',
      category: 'Control',
      status: 'Rollout ready',
      summary: 'Role-native routines, manager review loops, AI copilot pairing, and data-discipline visibility for every function.',
      users: ['tenant admin', 'director', 'plant manager', 'receiving clerk', 'procurement lead', 'quality manager', 'maintenance lead', 'sales lead'],
      route: '/app/workforce',
      dataFlows: ['role routines', 'entry quality', 'manager cadence', 'copilot coverage'],
      controls: ['role-home clarity', 'manager review discipline', 'training recovery', 'adoption accountability'],
    },
    {
      id: 'data-fabric',
      name: 'Data Fabric',
      category: 'Control',
      status: 'Rollout ready',
      summary: 'Promotes Drive folders, Gmail threads, ERP exports, and team writeback into topic marts, feature tables, and role-specific stories.',
      users: ['tenant admin', 'director', 'plant manager', 'procurement lead', 'quality manager', 'maintenance lead', 'sales lead', 'finance controller'],
      route: '/app/data-fabric',
      dataFlows: ['source events', 'canonical records', 'feature marts', 'role stories', 'writeback completeness'],
      controls: ['lineage', 'freshness', 'topic scopes', 'feature review', 'writeback gating'],
    },
    {
      ...
      category: 'Control',
      status: 'Next module',
      summary: 'Runs data cleaning, KPI control, feature engineering, anomaly scoring, SWOT packs, and gap analysis across sales and operations data.',
      users: ['tenant admin', 'director', 'plant manager', 'sales lead'],
      route: '/app/insights',
      dataFlows: ['clean datasets', 'feature tables', 'forecast signals', 'scenario models', 'gap-analysis packs'],
      controls: ['model review', 'feature freshness', 'forecast confidence', 'gap review'],
    },
    {
  ...
  roles: [
    ...
    },
    {
      ...
      defaultHome: '/app/operations',
      capabilities: ['actions.view', 'receiving.view', 'operations.view', 'dqms.view', 'approvals.view'],
    ...
    },
    {
      ...
      capabilities: ['actions.view', 'dqms.view', 'approvals.view', 'documents.view', 'knowledge_admin.view'],
    ...
    },
    {
      ...
      capabilities: ['actions.view', 'maintenance.view', 'inventory.view', 'documents.view'],
  ...
  connectors: [
    ...
    },
    {
      ...
      scope: 'PO, GRN, stock, invoice, branch movement, batch, and production data',
      cadence: 'Daily or intraday batch',
      outputs: ['inventory signals', 'variance watch', 'supplier exposure', 'batch genealogy'],
      adminOwner: 'tenant admin',
      writeBack: 'Controlled import rows and reconciliation views',
    },
    {
      id: 'chat-ops',
      name: 'Chat Operations Mesh',
      source: 'Viber, LINE, WeChat, and other controlled chat exports',
      scope: 'Supplier follow-up, dealer updates, management escalation, and operator coordination threads',
      cadence: 'Near-real-time ingest target',
      outputs: ['chat-linked tasks', 'decision evidence', 'follow-up prompts'],
      adminOwner: 'tenant admin',
      writeBack: 'Draft summaries and routed next actions',
    },
    {
      id: 'shopfloor-signals',
      name: 'Shopfloor Logs and Lab Sheets',
      source: 'Machine logs, downtime sheets, lab trackers, and mobile operator entry',
      scope: 'Mixing, extrusion, calender, building, curing, inspection, and downtime evidence',
      cadence: 'Shift-based or live entry',
      outputs: ['process drift alerts', 'OEE signals', 'incident starters', 'traceability markers'],
      adminOwner: 'plant manager',
      writeBack: 'Controlled imports and line-review flags',
    },
    {
      id: 'markdown-vault',
  ...
  knowledgeGraph: [
    ...
    },
    {
      ...
      feeds: ['DQMS and Quality Methods', 'Inventory Pulse'],
    },
    {
      id: 'compound_batch',
      name: 'Compound and Recipe Lot',
      summary: 'Compound genealogy linking raw materials, lab release, machine use, and downstream tyre batches.',
      sourceOfTruth: 'ERP extracts + lab SPC + shopfloor logs',
      updatePattern: 'Compound release, machine consumption, and deviation review',
      feeds: ['Manufacturing Command', 'Lab SPC and Release', 'DQMS and Quality Methods'],
    },
    {
      id: 'asset',
      ...
      feeds: ['Maintenance Control', 'DQMS and Quality Methods', 'Knowledge Graph and SOP Vault'],
    },
    {
      id: 'quality_incident',
      name: 'Quality Incident and CAPA',
      summary: 'A quality event linked to batch, supplier, containment, and closeout.',
      sourceOfTruth: 'DQMS and Quality Methods + Gmail quality matches',
      updatePattern: 'Incident intake, evidence uploads, and manager signoff',
      feeds: ['DQMS and Quality Methods', 'CEO Command Center', 'Knowledge Graph and SOP Vault'],
    },
    {
      id: 'account',
    ...
    },
    {
      ...
      summary: 'Threshold-bearing KPI rows tied back to source data, owners, industrial targets, and quality methods.',
      sourceOfTruth: 'Metric intake + ERP extracts',
      updatePattern: 'Scheduled imports and operator correction',
      feeds: ['CEO Command Center', 'Inventory Pulse', 'DQMS and Quality Methods', 'Operating Intelligence Studio'],
    },
  ],
  dataEntrySurfaces: [
    {
    ...
    },
    {
      ...
      qualityRules: ['metric source required', 'owner required', 'reviewed in management cadence'],
    },
    {
  ...
  agentPods: [
    ...
    },
    {
      ...
      purpose: 'Connects raw-material, compound, machine, batch, and finished-tyre history into traceable operating evidence.',
      workspace: 'ytf/factory',
      leadRole: 'plant_manager',
      members: ['genealogy linker', 'process drift watcher', 'traceability reviewer'],
      readScope: ['ERP extracts', 'shopfloor logs', 'lab sheets', 'quality incidents'],
      writeScope: ['traceability packs', 'drift alerts', 'repeat-batch tags'],
      approvalGate: 'Batch-containment or supplier-impacting tags need plant or quality approval.',
      automations: ['genealogy refresh', 'drift watch', 'batch trace pack'],
    },
    {
    ...
    },
    {
      ...
      purpose: 'Cleans tenant data, engineers features, and produces KPI, gap-analysis, and model-backed operating signals for sales and plant leadership.',
      ...
      writeScope: ['clean datasets', 'feature tables', 'forecast drafts', 'risk flags', 'gap-analysis packs'],
      approvalGate: 'Model outputs stay advisory until a CEO or admin accepts them into live decisions.',
      automations: ['dataset cleanup', 'feature refresh', 'weekly forecast run', 'gap-analysis refresh'],
    },
  ],
  foundationSignals: [
    {
    ...
    },
    {
      ...
      status: 'Needs wiring',
      detail: 'The tenant now has an explicit operating-intelligence module and data-science pod, but live feature tables, KPI baselines, and forecast jobs still need backend wiring.',
    },
  ],
  gaps: [
    {
    ...
    },
    {
      ...
      risk: 'Data cleaning, KPI gap packs, and forecast outputs can scale faster than trust if they are not measured against approvals and outcomes.',
      nextMove: 'Add evals, recommendation scoring, and rollback-safe promotion gates for model-backed signals and DQMS suggestions.',
    },
  ],
  platformTeams: [
    {
    ...
    },
    {
      ...
      mission: 'Keeps the knowledge graph, KPI logic, cleaned datasets, and model-backed signals trustworthy.',
      scope: ['knowledge graph', 'operating intelligence studio', 'data science pod'],
      successMetric: 'Management can trust tenant data because records, KPI gaps, and model outputs stay cleaner, fresher, and easier to explain.',
    },
    {
      id: 'ytf-admin',
  ...
  rolloutPhases: [
    ...
    },
    {
      ...
      modules: ['Receiving Control', 'Operations Control', 'Plant Manager Interface', 'Supplier Control', 'Inventory Pulse', 'Document Intelligence', 'Workforce Command', 'Adoption Command'],
      deliverables: ['receiving entry discipline', 'daily manager review', 'supplier evidence chase', 'stock-pressure watch', 'role-home adoption', 'role-score visibility'],
    },
    {
      id: 'phase-3',
      ...
      modules: ['Maintenance Control', 'DQMS and Quality Methods', 'Plant Manager Interface', 'Decision Journal', 'Knowledge Graph and SOP Vault', 'Workforce Command'],
      deliverables: ['maintenance issue tracking', 'CAPA closeout flow', 'root-cause records', 'markdown-to-knowledge sync', 'manager review standard work'],
    },
    {
      id: 'phase-4',
      ...
      modules: ['Data Fabric', 'Operating Intelligence Studio', 'Document Intelligence', 'Knowledge Graph and SOP Vault', 'CEO Command Center'],
      deliverables: ['whole-folder ingestion', 'topic marts', 'feature refresh', 'forecast briefs', 'gap-analysis packs', 'role-specific storytelling', 'proactive control-room alerts'],
    },
  ],
}
