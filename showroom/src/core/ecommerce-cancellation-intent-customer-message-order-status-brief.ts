...
export type EcommerceCancellationIntentCustomerMessageOrderStatusBrief = {
  totalIntents: number
...
export function projectEcommerceCancellationIntentCustomerMessageOrderStatusBrief(
  buying: EcommerceBuyingState,
): EcommerceCancellationIntentCustomerMessageOrderStatusBrief {
