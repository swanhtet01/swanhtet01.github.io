...
export type EcommerceAmendmentIntentCustomerMessageToFulfilmentBrief = {
  totalIntents: number
...
export function projectEcommerceAmendmentIntentCustomerMessageToFulfilmentBrief(
  buying: EcommerceBuyingState,
): EcommerceAmendmentIntentCustomerMessageToFulfilmentBrief {
  ...
  for (const intent of buying.amendmentIntents) {
    const isDelivery = intent.toFulfilment === 'delivery'
