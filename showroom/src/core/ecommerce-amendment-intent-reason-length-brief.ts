...
export type EcommerceAmendmentIntentReasonLengthBrief = {
  totalIntents: number
  shortCount: number
  mediumCount: number
  longCount: number
...
export function projectEcommerceAmendmentIntentReasonLengthBrief(
  buying: EcommerceBuyingState,
): EcommerceAmendmentIntentReasonLengthBrief {
  let shortCount = 0
  let mediumCount = 0
  let longCount = 0
  let totalLength = 0
