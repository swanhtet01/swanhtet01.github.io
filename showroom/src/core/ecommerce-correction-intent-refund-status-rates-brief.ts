...
export type EcommerceCorrectionIntentRefundStatusRatesBrief = {
  totalIntents: number
  noneCount: number
  noneRate: number
  dueCount: number
...
export function projectEcommerceCorrectionIntentRefundStatusRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceCorrectionIntentRefundStatusRatesBrief {
