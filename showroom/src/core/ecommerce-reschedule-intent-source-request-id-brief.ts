...
export type EcommerceRescheduleIntentSourceRequestIdBrief = {
  totalIntents: number; uniqueSourceRequests: number; topSourceRequest: string | null; topSourceRequestCount: number
}
export function projectEcommerceRescheduleIntentSourceRequestIdBrief(buying: EcommerceBuyingState) {
