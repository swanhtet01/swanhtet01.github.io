...
export type EcommerceRescheduleIntentCustomerMessageOrderStatusBrief = {
  totalIntents: number
...
export function projectEcommerceRescheduleIntentCustomerMessageOrderStatusBrief(
  buying: EcommerceBuyingState,
): EcommerceRescheduleIntentCustomerMessageOrderStatusBrief {
