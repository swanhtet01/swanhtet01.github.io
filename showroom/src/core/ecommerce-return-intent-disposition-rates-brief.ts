...
export type EcommerceReturnIntentDispositionRatesBrief = {
  totalIntents: number
  restockCount: number
  restockRate: number
...
export function projectEcommerceReturnIntentDispositionRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceReturnIntentDispositionRatesBrief {
