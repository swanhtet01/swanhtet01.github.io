...
export type EcommerceSupportIntentEvidenceReferenceBrief = {
  totalIntents: number
...
export function projectEcommerceSupportIntentEvidenceReferenceBrief(
  buying: EcommerceBuyingState,
): EcommerceSupportIntentEvidenceReferenceBrief {
