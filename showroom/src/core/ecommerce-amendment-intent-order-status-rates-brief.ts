...
export type EcommerceAmendmentIntentOrderStatusRatesBrief = {
  totalIntents: number
...
export function projectEcommerceAmendmentIntentOrderStatusRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceAmendmentIntentOrderStatusRatesBrief {
