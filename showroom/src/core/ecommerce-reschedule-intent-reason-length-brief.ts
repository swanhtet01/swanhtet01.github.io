...
export type EcommerceRescheduleIntentReasonLengthBrief = {
  totalIntents: number
  shortCount: number
  mediumCount: number
  longCount: number
...
export function projectEcommerceRescheduleIntentReasonLengthBrief(
  buying: EcommerceBuyingState,
): EcommerceRescheduleIntentReasonLengthBrief {
  let shortCount = 0
  let mediumCount = 0
  let longCount = 0
  let totalLength = 0
