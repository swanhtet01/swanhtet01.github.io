...
export type EcommerceAmendmentIntentCustomerMessageSentRatesBrief = {
  totalIntents: number
...
export function projectEcommerceAmendmentIntentCustomerMessageSentRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceAmendmentIntentCustomerMessageSentRatesBrief {
