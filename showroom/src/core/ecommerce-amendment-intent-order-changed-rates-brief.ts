...
export type EcommerceAmendmentIntentOrderChangedRatesBrief = {
  totalIntents: number
...
export function projectEcommerceAmendmentIntentOrderChangedRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceAmendmentIntentOrderChangedRatesBrief {
