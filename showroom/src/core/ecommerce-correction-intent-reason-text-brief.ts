...
export type EcommerceCorrectionIntentReasonTextBrief = {
  totalIntents: number
  shortCount: number
  mediumCount: number
  longCount: number
...
export function projectEcommerceCorrectionIntentReasonTextBrief(
  buying: EcommerceBuyingState,
): EcommerceCorrectionIntentReasonTextBrief {
  let shortCount = 0
  let mediumCount = 0
  let longCount = 0
  let totalLength = 0
