...
export type EcommerceSupportIntentRefundStartedRatesBrief = {
  totalIntents: number
...
export function projectEcommerceSupportIntentRefundStartedRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceSupportIntentRefundStartedRatesBrief {
