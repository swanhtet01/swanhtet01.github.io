...
export type EcommerceRescheduleIntentFulfilmentRatesBrief = {
  totalIntents: number
...
export function projectEcommerceRescheduleIntentFulfilmentRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceRescheduleIntentFulfilmentRatesBrief {
  ...
  for (const intent of buying.rescheduleIntents) {
    if (intent.fulfilment === 'delivery') deliveryCount++
  }
