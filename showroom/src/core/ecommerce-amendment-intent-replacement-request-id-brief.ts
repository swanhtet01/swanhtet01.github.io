...
export type EcommerceAmendmentIntentReplacementRequestIdBrief = {
  totalIntents: number; uniqueReplacements: number; topReplacement: string | null; topReplacementCount: number
}
export function projectEcommerceAmendmentIntentReplacementRequestIdBrief(buying: EcommerceBuyingState) {
