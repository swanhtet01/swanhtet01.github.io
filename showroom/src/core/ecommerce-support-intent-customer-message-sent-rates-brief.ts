...
export type EcommerceSupportIntentCustomerMessageSentRatesBrief = {
  totalIntents: number
...
export function projectEcommerceSupportIntentCustomerMessageSentRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceSupportIntentCustomerMessageSentRatesBrief {
