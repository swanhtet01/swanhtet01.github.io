...
export type EcommerceAmendmentIntentSourceRequestIdBrief = {
  totalIntents: number; uniqueSourceRequests: number; topSourceRequest: string | null; topSourceRequestCount: number
}
export function projectEcommerceAmendmentIntentSourceRequestIdBrief(buying: EcommerceBuyingState) {
