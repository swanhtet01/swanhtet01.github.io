...
export type EcommerceRescheduleIntentStockChangedRatesBrief = {
  totalIntents: number
...
export function projectEcommerceRescheduleIntentStockChangedRatesBrief(
  buying: EcommerceBuyingState,
): EcommerceRescheduleIntentStockChangedRatesBrief {
