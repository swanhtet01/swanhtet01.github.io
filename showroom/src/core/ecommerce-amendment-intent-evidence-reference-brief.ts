...
export type EcommerceAmendmentIntentEvidenceReferenceBrief = {
  totalIntents: number
...
export function projectEcommerceAmendmentIntentEvidenceReferenceBrief(
  buying: EcommerceBuyingState,
): EcommerceAmendmentIntentEvidenceReferenceBrief {
