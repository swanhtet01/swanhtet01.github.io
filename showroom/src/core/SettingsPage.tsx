          ...
          <>
            ...
            {demoBlueprint ? <section aria-label="Client demo kit" className="demo-kit-result">
              ...
              {preparedArtifact ? <section aria-label="Private client package installer" className="setup-template-summary">
                ...
                {preparedArtifact.shopAccountingScopeReview ? <div className="template-contract" data-shop-accounting-scope-review="required"><span>Shop business and location</span><strong>{preparedArtifact.shopAccountingScopeReview.entity.name} · {preparedArtifact.shopAccountingScopeReview.locations.map((location) => location.name).join(', ')}</strong><small>After installation, review the entity code and each location in Shop Daily close before creating real orders. Nothing is applied from this package.</small></div> : null}
