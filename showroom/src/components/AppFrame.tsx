...
const appNavItems: Array<{ label: string; to: string; requires: WorkspaceCapability[] }> = [
  ...
  { label: 'Runtime', to: '/app/runtime', requires: ['connector_admin.view', 'knowledge_admin.view', 'security_admin.view', 'tenant_admin.view', 'platform_admin.view'] },
  ...
  { label: 'Security', to: '/app/security', requires: ['security_admin.view', 'tenant_admin.view', 'platform_admin.view'] },
