...
class ManagedContextUnitTests(unittest.TestCase):
    ...
    def test_context_contract_rejects_extra_fields_raw_rows_training_and_incomplete_proof(self) -> None:
        ...
        training["modelTrainingAllowed"] = True
        cases.append(training)
        raw = context_package()
        raw["rawProductRecordsIncluded"] = True
        cases.append(raw)
...
class ManagedContextRouteTests(unittest.TestCase):
    ...
    def test_zero_write_validation_then_human_retention_is_audited_and_idempotent(self) -> None:
        ...
        self.assertEqual(payload["validation"]["contract"], "supermega.managed_context_profile_validation.v1")
        ...
        self.assertEqual(retained_payload["retention"]["contract"], "supermega.managed_context_profile_retention.v1")
        ...
        self.assertEqual(
            ...
            {"contract", "version", "profileDigest", "preferredProduct"},
        )
