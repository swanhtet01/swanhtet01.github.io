...
class LegacyPilotSecurityTests(unittest.TestCase):
    ...
    def test_agent_runner_cycle_budget_is_canonical_bounded_and_scale_to_zero(self) -> None:
        ...
        self.assertEqual(queued["process_limit"], 4)
        self.assertEqual(queued["max_processed_per_cycle"], 4)
        ...
        self.assertEqual(canonical["process_limit"], 4)
        ...
        for values, durable_queue, error in (
            ...
            (["ops_watch", "github_release_watch", "task_triage", "founder_brief", "template_clerk"], False, "workspace_login_job_limit_exceeded"),
