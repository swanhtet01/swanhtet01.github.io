...
- `/products/website/` — **Website**: lazy-loaded Pages, Navigation, and Publish workflow with responsive preview, revisioned evidence, approval, and snapshot records; authenticated v3 workspaces sync through the managed API and all other sessions remain local or fail closed.
