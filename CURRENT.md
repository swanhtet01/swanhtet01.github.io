...
- `/operations/commerce/?tab=today` — **Commerce**: Website and channel orders, fulfilment, stock, local payment status, and daily close. The retired `/products/ecommerce/` path redirects to Commerce Orders.
