...
echo "Running legacy serve_solution.py / mark1_pilot portal smoke only; not SuperMega readiness proof, release proof, commercial proof, or Shop pilot evidence." >&2
