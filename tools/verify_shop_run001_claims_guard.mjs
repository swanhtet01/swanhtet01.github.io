...
requireSnippet(baselineMeasurementText, 'The owner-safe launch-gate report must be written and verified before Day-0 readiness', files.baselineMeasurement)
