...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `db5abd6`')
  ...
  && workboard.includes('Keep product checkpoint `db5abd6`')
  && workboard.includes('current 194-commit local product delta')
  && now.includes('Checkpoint `db5abd6` is the accepted local product')
  ...
  && now.includes('fast-forward 148 commits beyond remote PR #258 head `338b6fd`')
