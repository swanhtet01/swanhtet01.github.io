...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `a400a86`')
  ...
  && now.includes('Current local checkpoints: product `a400a86`')
  ...
  && now.includes('Product checkpoint `a400a86` is on a clean fast-forward descendant')
