...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `62a2fdf`')
  ...
  && now.includes('Current local checkpoints: product `ca7c95d`')
  ...
  && now.includes('Product checkpoint `ca7c95d` is on a clean fast-forward descendant')
  && now.includes('Managed Shop Stock persists two-location/lot setup')
  && now.includes('purchase receipts allocated to one destination and new lot')
