...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `8f3114e`')
  ...
  && now.includes('Current local checkpoints: product `8f3114e`')
  ...
  && now.includes('Product checkpoint `8f3114e` is on a clean fast-forward descendant')
