...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `6465173`')
  ...
  && now.includes('Current local checkpoints: product `6465173`')
  ...
  && now.includes('Product checkpoint `6465173` is on a clean fast-forward descendant')
  && now.includes('Shop Stock keeps local and managed locations in Commerce')
  && now.includes('Legacy standalone browser records stay untouched but inactive')
