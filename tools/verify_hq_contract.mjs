...
requireContract('agent roster consolidation is recorded',
  ...
  && workboard.includes('Current accepted agent-operations checkpoint: `ca5070e`')
  && now.includes('operating checkpoint `63a245f`')
  && now.includes('agent-operations checkpoint `ca5070e`')
...
requireContract('agent security brief is reconciled to current controls',
  agentSecurity.includes('Agent-operations checkpoint: `ca5070e`')
  ...
  && agentSecurity.includes('a real PowerShell probe proves a sentinel cron token')
  ...
  && agentSecurity.includes('Select one scheduler authority and harden exact cadence')
...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `ab9a89e`')
  ...
  && workboard.includes('| ENG-074 | Product Platform + Architecture Codex | ready |')
  && workboard.includes('| ENG-075 | Shop + Data Engineering Codex | queued |')
  ...
  && workboard.includes('Keep product checkpoint `ab9a89e`')
  && workboard.includes('Execute ENG-074 first')
  && now.includes('`ab9a89e` is the current local product checkpoint')
