...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `15c7687`')
  ...
  && workboard.includes('Keep product checkpoint `15c7687`')
  && workboard.includes('current 198-commit local product delta')
  && now.includes('Checkpoint `15c7687` is the accepted local product')
  ...
  && now.includes('largest JavaScript chunk is 463,277 bytes')
  && now.includes('fast-forward 152 commits beyond remote PR #258 head `338b6fd`')
