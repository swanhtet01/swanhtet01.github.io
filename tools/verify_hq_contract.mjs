...
requireContract('agent security brief is reconciled to current controls',
  agentSecurity.includes('Agent-operations checkpoint: `63a245f`')
  ...
  && agentSecurity.includes('Request explicit owner approval for one normal fast-forward-only push')
