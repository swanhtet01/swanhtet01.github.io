...
requireContract('agent roster consolidation is recorded',
  workboard.includes('Current accepted operating checkpoint: `ff2007d`')
  ...
  && now.includes('operating checkpoint `ff2007d`')
...
requireContract('agent security brief is reconciled to current controls',
  agentSecurity.includes('Agent-operations checkpoint: `ff2007d`')
  ...
  && agentSecurity.includes('Rehearse human release review in isolation')
