...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `17b458f48f170298db8acc9f543f1e1e093b6c8e`')
  ...
  && now.includes('Current checkpoints: product `17b458f`, release `2b25e747`')
...
requireContract('release history is retained and current live state is discoverable',
  ...
  && now.includes('Both `supermega.dev` and `app.supermega.dev` serve exact commit `2b25e747c1818703031a3bfcb958f7669655a157`'))
requireContract('workboard release authority and active execution order are current',
  ...
  && workboard.includes('Current accepted release checkpoint: `2b25e747c1818703031a3bfcb958f7669655a157`')
