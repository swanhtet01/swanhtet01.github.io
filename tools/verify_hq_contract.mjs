...
requireContract('CEO four-product and innovation goal is explicit',
  ...
  && ceoProductGoal.includes('Build the smallest SuperMega Sync slice')
...
requireContract('route quality report preserves current evidence and production caveat',
  ...
  && productQualityReport.includes('ten browser workflow gates')
  && productQualityReport.includes('78 deterministic checkpoints')
