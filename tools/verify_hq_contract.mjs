...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `b760a9f`')
  ...
  && now.includes('Current local checkpoints: product `b760a9f`')
  ...
  && now.includes('Product checkpoint `b760a9f` is on a clean fast-forward descendant')
