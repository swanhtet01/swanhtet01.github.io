...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `8182491`')
  ...
  && now.includes('Checkpoint `8182491` is the accepted local product')
  ...
  && now.includes('fast-forward 140 commits beyond remote PR #258 head `338b6fd`'))
