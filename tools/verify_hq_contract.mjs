...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `c7c283c`')
  ...
  && now.includes('Current local checkpoints: product `c7c283c`')
  ...
  && now.includes('Product checkpoint `c7c283c` is on a clean fast-forward descendant')
