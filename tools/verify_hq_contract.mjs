...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `ffd1d8ca907472281d46b4a234c24f2b5143895c`')
  ...
  && now.includes('Live HQ and both domains agree on `ffd1d8ca`; no release drift is present.')
