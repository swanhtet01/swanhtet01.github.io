...
requireContract('Ally CEO execution uses one exact local-company run and no external action surface',
  ...
  && allyCeoLocalCycleText.includes("EXECUTION_SPEC_VERSION = '2026-07-29.12'")
  && allyCeoLocalCycleText.includes("LEGACY_EXECUTION_SPEC_VERSIONS = Object.freeze(['2026-07-29.11', '2026-07-29.10'])")
  && allyCeoLocalCycleText.includes('`[ALLY_CEO_OUTCOME:${period}:${outcomeId}]`')
  && allyCeoLocalCycleText.includes('`[ALLY_CEO_REPAIR:${period}:${outcomeId}]`')
