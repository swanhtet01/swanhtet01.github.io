...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `ebf0c61`')
  ...
  && workboard.includes('Keep product checkpoint `ebf0c61`')
  && workboard.includes('current 192-commit local product delta')
  && now.includes('Checkpoint `ebf0c61` is the accepted local product')
  ...
  && now.includes('fast-forward 146 commits beyond remote PR #258 head `338b6fd`')
