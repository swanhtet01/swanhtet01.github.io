...
requireContract('agent roster consolidation is recorded',
  workboard.includes('Current accepted operating checkpoint: `ee34358`')
  ...
  && now.includes('operating checkpoint `ee34358`')
...
requireContract('agent security brief is reconciled to current controls',
  agentSecurity.includes('Agent-operations checkpoint: `ee34358`')
  ...
  && agentSecurity.includes('Bind human release review to the exact candidate')
