...
requireContract('agent roster consolidation is recorded',
  ...
  && now.includes('Product: four-product setup handoff and Plant CAPA release gates pass.')
...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `b898272d884ac372e32e15518809a1580405ac33`')
  ...
  && now.includes('Live HQ and both domains agree on `b898272d`; no release drift is present.')
...
requireContract('live client setup handoff release is retained without overstated authority',
  ...
  && now.includes('Successful create/update focuses its sole `Open next demo` action')
  ...
  && enterpriseRoadmap.includes('this does not prove mobile, reload, export, reset, restore, managed persistence, or activation'))
