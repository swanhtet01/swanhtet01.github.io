...
requireContract('release evidence is current', now.includes('PR `#258`')
  && now.includes('GitHub is the source of truth for its pushed head')
  && now.includes('99a57f6385cfe582ded0e5c5c4034372d7899458')
  && now.includes('run `153` passed every validation job')
  && now.includes('169 product/runtime checks')
