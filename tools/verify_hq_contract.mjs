...
requireContract('accepted core checkpoints lead directly to real work',
  ...
  && workboard.includes('| ENG-076 | Plant + Manufacturing Engineering Codex | ready |')
  ...
  && workboard.includes('Keep product checkpoint `2790f9d`')
  && workboard.includes('Execute ENG-076 first')
  && now.includes('Current local checkpoints: product `2790f9d`')
  ...
  && now.includes('largest JavaScript chunk is 476,008 bytes')
