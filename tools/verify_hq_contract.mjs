...
const completedAutomationArchiveText = await readFile(resolve(root, 'hq', 'archive', 'completed-local-automations-through-ops-224.json'), 'utf8')
...
requireContract('one bounded agent operating model is authoritative',
  ...
  && portfolioSource.completedLocalAutomationArchive.path === 'archive/completed-local-automations-through-ops-224.json'
  && portfolioSource.completedLocalAutomationArchive.count === 72
  && portfolioSource.completedLocalAutomationArchive.throughCheckpoint === 'OPS-224'
  ...
  && portfolio.completedLocalAutomations[69]?.productId === 'plant'
  && portfolio.completedLocalAutomations[69]?.workOrderId === 'plant-job-import-all-row-repeat-detection'
  && portfolio.completedLocalAutomations[69]?.checkpoint === 'OPS-222'
  && portfolio.completedLocalAutomations[70]?.productId === 'plant'
  && portfolio.completedLocalAutomations[70]?.workOrderId === 'plant-job-import-priority-repair'
  && portfolio.completedLocalAutomations[70]?.checkpoint === 'OPS-223'
  && portfolio.completedLocalAutomations[71]?.productId === 'plant'
  && portfolio.completedLocalAutomations[71]?.workOrderId === 'plant-job-import-template-download'
  && portfolio.completedLocalAutomations[71]?.checkpoint === 'OPS-224'
  && portfolio.completedLocalAutomations[72]?.productId === 'plant'
  && portfolio.completedLocalAutomations[72]?.workOrderId === 'plant-job-import-next-ready-focus'
  && portfolio.completedLocalAutomations[72]?.checkpoint === 'OPS-225'
  && portfolio.completedLocalAutomations[73]?.productId === 'website'
  && portfolio.completedLocalAutomations[73]?.workOrderId === 'website-brief-to-artifact-current-acceptance'
  && portfolio.completedLocalAutomations[73]?.checkpoint === 'OPS-226'
  && portfolio.completedLocalAutomations[74]?.productId === 'ecommerce'
  && portfolio.completedLocalAutomations[74]?.workOrderId === 'ecommerce-catalog-to-shop-review-current-acceptance'
  && portfolio.completedLocalAutomations[74]?.checkpoint === 'OPS-227'
  && portfolio.completedLocalAutomations[75]?.productId === 'ecommerce'
  && portfolio.completedLocalAutomations[75]?.workOrderId === 'ecommerce-real-catalog-first-onboarding'
  && portfolio.completedLocalAutomations[75]?.checkpoint === 'OPS-228'
  && portfolio.completedLocalAutomations[76]?.productId === 'shop'
  && portfolio.completedLocalAutomations[76]?.workOrderId === 'shop-real-catalog-first-onboarding'
  && portfolio.completedLocalAutomations[76]?.checkpoint === 'OPS-229'
  && portfolio.completedLocalAutomations[77]?.productId === 'plant'
  && portfolio.completedLocalAutomations[77]?.workOrderId === 'plant-real-job-first-onboarding'
  && portfolio.completedLocalAutomations[77]?.checkpoint === 'OPS-230'
  && portfolio.completedLocalAutomations[78]?.productId === 'plant'
  && portfolio.completedLocalAutomations[78]?.workOrderId === 'plant-real-shift-close-client-acceptance'
  && portfolio.completedLocalAutomations[78]?.checkpoint === 'OPS-231'
  ...
  && portfolio.completedLocalAutomations[81]?.productId === 'ecommerce'
  && portfolio.completedLocalAutomations[81]?.workOrderId === 'ecommerce-real-order-close-client-acceptance'
  && portfolio.completedLocalAutomations[81]?.checkpoint === 'OPS-234'
  && portfolio.completedLocalAutomations[82]?.productId === 'ecommerce'
  && portfolio.completedLocalAutomations[82]?.workOrderId === 'ecommerce-real-order-return-client-acceptance'
  && portfolio.completedLocalAutomations[82]?.checkpoint === 'OPS-235'
  ...
  && portfolio.completedLocalAutomations[85]?.productId === 'shop'
  && portfolio.completedLocalAutomations[85]?.workOrderId === 'shop-real-order-accounting-close-client-acceptance'
  && portfolio.completedLocalAutomations[85]?.checkpoint === 'OPS-238'
  && portfolio.completedLocalAutomations[86]?.productId === 'shop'
  && portfolio.completedLocalAutomations[86]?.workOrderId === 'shop-real-order-accounting-location-client-acceptance'
  && portfolio.completedLocalAutomations[86]?.checkpoint === 'OPS-239'
  && portfolio.completedLocalAutomations[87]?.productId === 'shop'
  && portfolio.completedLocalAutomations[87]?.workOrderId === 'shop-accounting-inventory-location-alignment-client-acceptance'
  && portfolio.completedLocalAutomations[87]?.checkpoint === 'OPS-240'
  && portfolio.completedLocalAutomations[88]?.productId === 'shop'
  && portfolio.completedLocalAutomations[88]?.workOrderId === 'shop-location-onboarding-handoff-client-acceptance'
  && portfolio.completedLocalAutomations[88]?.checkpoint === 'OPS-241'
  && portfolio.completedLocalAutomations[89]?.productId === 'shop'
  && portfolio.completedLocalAutomations[89]?.workOrderId === 'shop-location-review-to-first-sale-client-acceptance'
  && portfolio.completedLocalAutomations[89]?.checkpoint === 'OPS-242'
  && portfolio.completedLocalAutomations[90]?.productId === 'shop'
  && portfolio.completedLocalAutomations[90]?.workOrderId === 'shop-stock-location-code-alignment-client-acceptance'
  && portfolio.completedLocalAutomations[90]?.checkpoint === 'OPS-243'
  && portfolio.completedLocalAutomations[91]?.productId === 'shop'
  && portfolio.completedLocalAutomations[91]?.workOrderId === 'shop-unscoped-close-guidance-client-acceptance'
  && portfolio.completedLocalAutomations[91]?.checkpoint === 'OPS-244'
  && portfolio.completedLocalAutomations[92]?.productId === 'shop'
  && portfolio.completedLocalAutomations[92]?.workOrderId === 'shop-first-location-foundation-gate-client-acceptance'
  && portfolio.completedLocalAutomations[92]?.checkpoint === 'OPS-245'
  && portfolio.completedLocalAutomations[93]?.productId === 'shop'
  && portfolio.completedLocalAutomations[93]?.workOrderId === 'shop-location-setup-blocker-recovery-client-acceptance'
  && portfolio.completedLocalAutomations[93]?.checkpoint === 'OPS-246'
  && portfolio.completedLocalAutomations[94]?.productId === 'shop'
  && portfolio.completedLocalAutomations[94]?.workOrderId === 'shop-setup-next-blocker-focus'
  && portfolio.completedLocalAutomations[94]?.checkpoint === 'OPS-247'
  && portfolio.completedLocalAutomations[95]?.productId === 'shop'
  && portfolio.completedLocalAutomations[95]?.workOrderId === 'shop-setup-recovery-history-closure'
  && portfolio.completedLocalAutomations[95]?.checkpoint === 'OPS-248'
  ...
  && portfolio.completedLocalAutomations[98]?.productId === 'shop'
  && portfolio.completedLocalAutomations[98]?.workOrderId === 'shop-required-scope-before-counter-entry'
  && portfolio.completedLocalAutomations[98]?.checkpoint === 'OPS-251'
  && portfolio.completedLocalAutomations[99]?.productId === 'shop'
  && portfolio.completedLocalAutomations[99]?.workOrderId === 'shop-required-scope-resume-order-entry'
  && portfolio.completedLocalAutomations[99]?.checkpoint === 'OPS-252'
  && portfolio.completedLocalAutomations[100]?.productId === 'shop'
  && portfolio.completedLocalAutomations[100]?.workOrderId === 'shop-required-scope-resume-online-entry'
  && portfolio.completedLocalAutomations[100]?.checkpoint === 'OPS-253'
  && portfolio.completedLocalAutomations[101]?.productId === 'shop'
  && portfolio.completedLocalAutomations[101]?.workOrderId === 'shop-local-ecommerce-inbox-review'
  && portfolio.completedLocalAutomations[101]?.checkpoint === 'OPS-254'
  && portfolio.completedLocalAutomations[102]?.productId === 'shop'
  && portfolio.completedLocalAutomations[102]?.workOrderId === 'shop-local-ecommerce-payment-selection'
  && portfolio.completedLocalAutomations[102]?.checkpoint === 'OPS-255'
  && portfolio.completedLocalAutomations[103]?.productId === 'shop'
  && portfolio.completedLocalAutomations[103]?.workOrderId === 'shop-local-ecommerce-order-confirmation'
  && portfolio.completedLocalAutomations[103]?.checkpoint === 'OPS-256'
  && portfolio.completedLocalAutomations[104]?.productId === 'shop'
  && portfolio.completedLocalAutomations[104]?.workOrderId === 'shop-local-ecommerce-fulfilment-timeline-acceptance'
  && portfolio.completedLocalAutomations[104]?.checkpoint === 'OPS-257'
  ...
  && portfolio.completedLocalAutomations[109]?.productId === 'plant'
  && portfolio.completedLocalAutomations[109]?.workOrderId === 'plant-controlled-batch-shift-evidence-alignment'
  && portfolio.completedLocalAutomations[109]?.checkpoint === 'OPS-262'
  && portfolio.completedLocalAutomations[110]?.productId === 'shop'
  && portfolio.completedLocalAutomations[110]?.workOrderId === 'shop-spa-realistic-template-onboarding'
  && portfolio.completedLocalAutomations[110]?.checkpoint === 'OPS-263'
  && portfolio.completedLocalAutomations[111]?.productId === 'shop'
  && portfolio.completedLocalAutomations[111]?.workOrderId === 'shop-spa-appointment-to-checkout-handoff'
  && portfolio.completedLocalAutomations[111]?.checkpoint === 'OPS-264'
  && portfolio.completedLocalAutomations[112]?.productId === 'shop'
  && portfolio.completedLocalAutomations[112]?.workOrderId === 'shop-spa-payment-and-daily-close-proof'
  && portfolio.completedLocalAutomations[112]?.checkpoint === 'OPS-265'
  && portfolio.completedLocalAutomations[113]?.productId === 'shop'
  && portfolio.completedLocalAutomations[113]?.workOrderId === 'shop-spa-role-access-and-staff-handoff'
  && portfolio.completedLocalAutomations[113]?.checkpoint === 'OPS-266'
  ...
  && portfolio.completedLocalAutomations[118]?.productId === 'shop'
  && portfolio.completedLocalAutomations[118]?.workOrderId === 'shop-spa-verified-staff-membership-activation'
  && portfolio.completedLocalAutomations[118]?.checkpoint === 'OPS-271'
  && workboard.includes('| OPS-271 | CEO + Shop Spa Identity Activation / Agent Operations Codex | done-local |')
  && portfolio.completedLocalAutomations[119]?.productId === 'shop'
  && portfolio.completedLocalAutomations[119]?.workOrderId === 'shop-spa-invitation-handoff-and-provider-receipt'
  && portfolio.completedLocalAutomations[119]?.checkpoint === 'OPS-272'
  && workboard.includes('| OPS-272 | CEO + Shop Spa Invitation Handoff / Agent Operations Codex | done-local |')
  && portfolio.completedLocalAutomations[120]?.productId === 'shop'
...
requireContract('accepted core checkpoints lead directly to real work',
  ...
  && now.includes('New location-managed orders reserve only from the canonical `LOC-*` bound to their reviewed scope')
  && now.includes('sellable returns restore exact lots')
  && now.includes('correction-aware accounting CSV retains reviewed scope and `LOC-*` through close/export')
  && now.includes('separates same-day books, rejects mixed scopes, and never posts')
...
requireContract('Shop finance roadmap separates reviewed handoff from tax and posting authority',
  ...
  && enterpriseRoadmap.includes('Checkpoint `032dee49` fixes the downstream payment-truth boundary')
  && enterpriseRoadmap.includes('supermega.commerce.close-settlement.v2')
  && enterpriseRoadmap.includes('supermega.commerce.daily-close-export.v4')
  && enterpriseRoadmap.includes('supermega.commerce.accounting-handoff.v4')
  ...
  && workboard.includes('| OPS-238 | CEO + Shop Accounting-close Client Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('| OPS-239 | CEO + Shop Accounting-location Client Acceptance / Agent Operations Codex | done-local |')
...
requireContract('local product improvement stays separate from managed-pilot authority',
  ...
  && workboard.includes('| OPS-222 | CEO + Plant All-row Repeat Detection / Agent Operations Codex | done-local |')
  && workboard.includes('records that nonempty ID before branching to blocked or ready state')
  && workboard.includes('The receipt advances `plant-job-import-priority-repair`')
  && workboard.includes('| OPS-223 | CEO + Plant Import Priority Repair / Agent Operations Codex | done-local |')
  && workboard.includes('Import now uses one explicit alias map')
  && workboard.includes('The receipt advances `plant-job-import-template-download`')
  && workboard.includes('| OPS-224 | CEO + Plant Import Template / Agent Operations Codex | done-local |')
  && workboard.includes('Chromium downloaded `supermega-plant-job-template.csv` as 129 UTF-8 BOM bytes')
  && workboard.includes('The receipt advances `plant-job-import-next-ready-focus`')
  && workboard.includes('| OPS-225 | CEO + Plant Next-ready Import / Agent Operations Codex | done-local |')
  && workboard.includes('waits for `mutateProduction` to succeed')
  && workboard.includes('The receipt advances `website-brief-to-artifact-current-acceptance`')
  && workboard.includes('| OPS-226 | CEO + Website Client-first Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('a pristine Website initialized on the populated grocery sample')
  && workboard.includes('11,200-byte Blob with identical SHA-256')
  && workboard.includes('The receipt advances `ecommerce-catalog-to-shop-review-current-acceptance`')
  && workboard.includes('| OPS-227 | CEO + Ecommerce Shop Handoff Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('suspends Ecommerce source hydration while an accountable confirmation is active')
  && workboard.includes('The receipt advances `ecommerce-real-catalog-first-onboarding`')
  && workboard.includes('| OPS-228 | CEO + Ecommerce Real-catalog Onboarding / Agent Operations Codex | done-local |')
  && workboard.includes('atomically replaces only the exact untouched demo')
  && workboard.includes('The duplicated product-wide `Next steps` navigator')
  && workboard.includes('The receipt advances `shop-real-catalog-first-onboarding`')
  && workboard.includes('| OPS-229 | CEO + Shop Real-catalog Onboarding / Agent Operations Codex | done-local |')
  && workboard.includes('Shop now leads with a required reviewed CSV intake')
  && workboard.includes('The receipt advances `plant-real-job-first-onboarding`')
  && workboard.includes('| OPS-230 | CEO + Plant Real-job Onboarding / Agent Operations Codex | done-local |')
  && workboard.includes('Plant now leads with a required reviewed job CSV intake')
  && workboard.includes('The receipt advances `plant-real-shift-close-client-acceptance`')
  && workboard.includes('| OPS-231 | CEO + Plant Shift-close Client Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('Plant now says `Prepare shift close` until a current handoff exists')
  && workboard.includes('The receipt advances `shop-real-order-close-client-acceptance`')
  ...
  && workboard.includes('| OPS-234 | CEO + Ecommerce Order-close Client Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('A versioned schema- and workspace-bound dismissal marker')
  && workboard.includes('The receipt advances `ecommerce-real-order-return-client-acceptance`')
  && workboard.includes('| OPS-235 | CEO + Ecommerce Return Client Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('accepting a paid completed-order return restored stock but left its refund state clear')
  && workboard.includes('The receipt advances `ecommerce-real-order-support-client-acceptance`')
  ...
  && workboard.includes('| OPS-238 | CEO + Shop Accounting-close Client Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('a 500 MMK credit correction reduced the close\'s expected Cash')
  && workboard.includes('supermega.commerce.close-settlement.v2')
  && workboard.includes('supermega.commerce.daily-close-export.v4')
  && workboard.includes('supermega.commerce.accounting-handoff.v4')
  && workboard.includes('The receipt advances `shop-real-order-accounting-location-client-acceptance`')
  && workboard.includes('| OPS-239 | CEO + Shop Accounting-location Client Acceptance / Agent Operations Codex | done-local |')
  && workboard.includes('supermega.commerce.daily-close-export.v5')
  && workboard.includes('supermega.commerce.accounting-handoff.v5')
  && workboard.includes('The receipt advances `shop-accounting-inventory-location-alignment-client-acceptance`')
  && workboard.includes('| OPS-240 | CEO + Shop Inventory-location Alignment / Agent Operations Codex | done-local |')
  && workboard.includes('An adversarial state with 10 units globally but only 2 at `LOC-MAIN`')
  && workboard.includes('The receipt advances `shop-location-onboarding-handoff-client-acceptance`')
  && workboard.includes('| OPS-241 | CEO + Shop Location-onboarding / Agent Operations Codex | done-local |')
  && workboard.includes('zero accounting-scope writes before founder confirmation')
  && workboard.includes('The receipt advances `shop-location-review-to-first-sale-client-acceptance`')
  && workboard.includes('| OPS-242 | CEO + Shop First-sale Handoff / Agent Operations Codex | done-local |')
  && workboard.includes('scope revisions advanced from two to three')
  && workboard.includes('The receipt advances `shop-stock-location-code-alignment-client-acceptance`')
  && workboard.includes('| OPS-243 | CEO + Shop Location-code Alignment / Agent Operations Codex | done-local |')
  && workboard.includes('selecting `LOC-MAIN` after explicitly entering `YGN-01` preserves `YGN-01`')
  && workboard.includes('The receipt advances `shop-unscoped-close-guidance-client-acceptance`')
  && workboard.includes('| OPS-244 | CEO + Shop Unscoped-close Guidance / Agent Operations Codex | done-local |')
  && workboard.includes('leaving the already-open `Business and location / Required before real orders` disclosure as the sole next action')
  && workboard.includes('The receipt advances `shop-first-location-foundation-gate-client-acceptance`')
  && workboard.includes('| OPS-245 | CEO + Shop First-location Gate / Agent Operations Codex | done-local |')
  && workboard.includes('Both real counter-sale and manual/channel-order entry now require an inventory foundation')
  && workboard.includes('The receipt advances `shop-location-setup-blocker-recovery-client-acceptance`')
  && workboard.includes('| OPS-246 | CEO + Shop Setup-blocker Recovery / Agent Operations Codex | done-local |')
  && workboard.includes('The Orders header hides New order while that intent is present')
  && workboard.includes('The receipt advances `shop-setup-next-blocker-focus`')
  && workboard.includes('| OPS-247 | CEO + Shop Setup-next-blocker Focus / Agent Operations Codex | done-local |')
  && workboard.includes('the first accountable cancellation moved URL, highlight, scroll, and keyboard focus to `ORD-1041`')
  && workboard.includes('The receipt advances `shop-setup-recovery-history-closure`')
  && workboard.includes('| OPS-248 | CEO + Shop Setup-recovery History / Agent Operations Codex | done-local |')
  && workboard.includes('browser Back stayed on that exact Stock route')
  && workboard.includes('The receipt advances `shop-location-setup-scalable-catalog`')
  ...
  && workboard.includes('| OPS-251 | CEO + Shop Required-scope Counter Entry / Agent Operations Codex | done-local |')
  && workboard.includes('never rendered `ShopCounter` or Current sale')
  && workboard.includes('The receipt advances `shop-required-scope-resume-order-entry`')
  && workboard.includes('| OPS-252 | CEO + Shop Required-scope Order Resume / Agent Operations Codex | done-local |')
  && workboard.includes('reopened the real `Add an order` composer')
  && workboard.includes('The receipt advances `shop-required-scope-resume-online-entry`')
  && workboard.includes('| OPS-253 | CEO + Shop Required-scope Online Resume / Agent Operations Codex | done-local |')
  && workboard.includes('reopened `Add an order` with `Online request` selected')
  && workboard.includes('The receipt advances `shop-local-ecommerce-inbox-review`')
  && workboard.includes('| OPS-254 | CEO + Shop Local Ecommerce Inbox / Agent Operations Codex | done-local |')
  && workboard.includes('prepared `Review Ecommerce request`')
  && workboard.includes('The receipt advances `shop-local-ecommerce-payment-selection`')
  && workboard.includes('| OPS-255 | CEO + Shop Local Ecommerce Payment / Agent Operations Codex | done-local |')
  && workboard.includes('opened the separate `Confirm Ecommerce request as order` gate')
  && workboard.includes('The receipt advances `shop-local-ecommerce-order-confirmation`')
  && workboard.includes('| OPS-256 | CEO + Shop Local Ecommerce Order / Agent Operations Codex | done-local |')
  && workboard.includes('created exactly one source-bound order')
  && workboard.includes('The receipt advances `shop-local-ecommerce-fulfilment-timeline-acceptance`')
  && workboard.includes('| OPS-257 | CEO + Shop Local Ecommerce Fulfilment / Agent Operations Codex | done-local |')
  && workboard.includes('The immutable request timeline reported `completed`, `nextAction: none`')
  && workboard.includes('The receipt advances `shop-local-ecommerce-daily-close-lineage-acceptance`')
  ...
  && workboard.includes('| OPS-262 | CEO + Plant Shift-evidence Alignment / Agent Operations Codex | done-local |')
  && workboard.includes('Product checkpoint `f836c315` projects a current source-bound controlled batch')
  && workboard.includes('The user-directed next slice became `shop-spa-realistic-template-onboarding`')
  && workboard.includes('| OPS-263 | CEO + Shop Spa Starter / Agent Operations Codex | done-local |')
  && workboard.includes('five treatments, three therapist-room stations, thirteen treatment and aftercare stock items')
  && workboard.includes('The receipt advances `shop-spa-appointment-to-checkout-handoff`')
  && workboard.includes('| OPS-264 | CEO + Shop Spa Checkout / Agent Operations Codex | done-local |')
  && workboard.includes('Cancel created zero orders')
  && workboard.includes('The receipt advances `shop-spa-payment-and-daily-close-proof`')
  && workboard.includes('| OPS-265 | CEO + Shop Spa Payment-close / Agent Operations Codex | done-local |')
  && workboard.includes('makes new Spa service orders enter as treatment complete and ready for payment')
  && workboard.includes('The receipt advances `shop-spa-role-access-and-staff-handoff`')
  && workboard.includes('| OPS-266 | CEO + Shop Spa Staff Access / Agent Operations Codex | done-local |')
  && workboard.includes('front desk receives schedule and visit-payment work')
  && workboard.includes('The receipt advances `shop-spa-client-record-and-consent-boundary`')
  ...
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'plant-job-import-all-row-repeat-detection' && entry.checkpoint === 'OPS-222')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'plant-job-import-priority-repair' && entry.checkpoint === 'OPS-223')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'plant-job-import-template-download' && entry.checkpoint === 'OPS-224')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'plant-job-import-next-ready-focus' && entry.checkpoint === 'OPS-225')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'website-brief-to-artifact-current-acceptance' && entry.checkpoint === 'OPS-226')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'ecommerce-catalog-to-shop-review-current-acceptance' && entry.checkpoint === 'OPS-227')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'ecommerce-real-catalog-first-onboarding' && entry.checkpoint === 'OPS-228')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-real-catalog-first-onboarding' && entry.checkpoint === 'OPS-229')
  ...
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-real-order-accounting-close-client-acceptance' && entry.checkpoint === 'OPS-238')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-real-order-accounting-location-client-acceptance' && entry.checkpoint === 'OPS-239')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-accounting-inventory-location-alignment-client-acceptance' && entry.checkpoint === 'OPS-240')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-location-onboarding-handoff-client-acceptance' && entry.checkpoint === 'OPS-241')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-location-review-to-first-sale-client-acceptance' && entry.checkpoint === 'OPS-242')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-stock-location-code-alignment-client-acceptance' && entry.checkpoint === 'OPS-243')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-unscoped-close-guidance-client-acceptance' && entry.checkpoint === 'OPS-244')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-first-location-foundation-gate-client-acceptance' && entry.checkpoint === 'OPS-245')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-location-setup-blocker-recovery-client-acceptance' && entry.checkpoint === 'OPS-246')
  ...
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-required-scope-before-counter-entry' && entry.checkpoint === 'OPS-251')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-required-scope-resume-order-entry' && entry.checkpoint === 'OPS-252')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-required-scope-resume-online-entry' && entry.checkpoint === 'OPS-253')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-local-ecommerce-inbox-review' && entry.checkpoint === 'OPS-254')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-local-ecommerce-payment-selection' && entry.checkpoint === 'OPS-255')
  ...
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'plant-controlled-batch-shift-evidence-alignment' && entry.checkpoint === 'OPS-262')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-spa-realistic-template-onboarding' && entry.checkpoint === 'OPS-263')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-spa-appointment-to-checkout-handoff' && entry.checkpoint === 'OPS-264')
  ...
  && workboard.includes('| OPS-271 | CEO + Shop Spa Identity Activation / Agent Operations Codex | done-local |')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-spa-verified-staff-membership-activation' && entry.checkpoint === 'OPS-271')
  && workboard.includes('| OPS-272 | CEO + Shop Spa Invitation Handoff / Agent Operations Codex | done-local |')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-spa-invitation-handoff-and-provider-receipt' && entry.checkpoint === 'OPS-272')
  && workboard.includes('| OPS-273 | CEO + Shop Spa Invitation Authority / Agent Operations Codex | done-local |')
  && portfolio.completedLocalAutomations.some((entry) => entry.workOrderId === 'shop-spa-one-attempt-invitation-authorization' && entry.checkpoint === 'OPS-273')
...
requireContract('Ally CEO planning is exact, bounded, temporary, and side-effect free',
  ...
  && allyCeoPlannerText.includes("COMPLETED_AUTOMATION_ARCHIVE_PATH = 'archive/completed-local-automations-through-ops-224.json'")
  ...
  && allyCeoPlannerCliText.includes("resolve(root, 'hq', 'archive', 'completed-local-automations-through-ops-224.json')")
...
requireContract('Ally CEO execution uses one exact local-company run and no external action surface',
  ...
  && allyCeoLocalCycleText.includes("resolve(root, 'hq', 'archive', 'completed-local-automations-through-ops-224.json')")
