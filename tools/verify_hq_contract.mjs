...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `f34177ac84d257870b45aa8d86a646759060fbb6`')
  ...
  && now.includes('Live HQ and both domains agree on `f34177ac`; no release drift is present.')
...
requireContract('live client setup handoff release is retained without overstated authority',
  ...
  && now.includes('Create/update focuses its sole `Open next demo` action')
  ...
  && enterpriseRoadmap.includes('mobile, import-correction, duplicate-handoff, export, managed persistence, and activation do not'))
requireContract('live local recovery release is retained without overstated authority',
  ...
  && now.includes('Reset and restore share one bounded record scope and one restore action')
