...
requireContract('accepted core checkpoints lead directly to real work',
  ...
  && now.includes('PR #263 merged exact Plant plan review and cross-platform verifier normalization')
...
requireContract('release history is retained and current live state is discoverable',
  ...
  && now.includes('Both `supermega.dev` and `app.supermega.dev` serve exact commit `85258393`'))
requireContract('workboard release authority and active execution order are current',
  ...
  && workboard.includes('Current accepted release checkpoint: `8525839388a64fe5768c02249cebdff760ce9813`')
  && workboardExecutionOrder.includes('paired live release `85258393`')
