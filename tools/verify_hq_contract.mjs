...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `8970424`')
  ...
  && workboard.includes('Keep product checkpoint `8970424`')
  && workboard.includes('current 190-commit local product delta')
  && now.includes('Checkpoint `8970424` is the accepted local product')
  ...
  && now.includes('fast-forward 144 commits beyond remote PR #258 head `338b6fd`')
  && now.includes('Local Vite health now reports `attention`, `isolated_demo`, and locked writes')
