...
requireContract('Ally CEO execution uses one exact local-company run and no external action surface',
  ...
  && allyCeoLocalCycleText.includes("EXECUTION_SPEC_VERSION = '2026-07-29.16'")
  && allyCeoLocalCycleText.includes("LEGACY_EXECUTION_SPEC_VERSIONS = Object.freeze(['2026-07-29.15', '2026-07-29.14', '2026-07-29.13', '2026-07-29.12', '2026-07-29.11', '2026-07-29.10'])")
