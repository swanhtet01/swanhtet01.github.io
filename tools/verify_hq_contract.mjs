...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `2a33640`')
  ...
  && now.includes('Current local checkpoints: product `2a33640`')
  ...
  && now.includes('Product checkpoint `2a33640` is on a clean fast-forward descendant')
