...
requireContract('Ally CEO execution uses one exact local-company run and no external action surface',
  ...
  && allyCeoLocalCycleText.includes('must begin with review, inspect, compare, or draft')
...
requireContract('current CEO platform evidence is recorded without expanding authority',
  ...
  && now.includes('released 2,270.7 MB without process stops; admission opened at 81.3% RAM')
  && now.includes('admission open at 84.6% RAM with zero loaded models and one idle worker'))
...
requireContract('rejected CEO outcomes are quarantined without repair loops or hidden completion',
  ...
  && now.includes('CEO period retains four accepted outcomes and one quarantined Finance/Risk artifact')
