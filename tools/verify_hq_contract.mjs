...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `3c885d8`')
  ...
  && now.includes('Current local checkpoints: product `3c885d8`')
  ...
  && now.includes('Product checkpoint `3c885d8` is on a clean fast-forward descendant')
