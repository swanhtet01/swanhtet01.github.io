...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `9f99457`')
  ...
  && workboard.includes('Keep product checkpoint `9f99457`')
  && workboard.includes('current 200-commit local product delta')
  && now.includes('Checkpoint `9f99457` is the accepted local product')
  ...
  && now.includes('largest JavaScript chunk is 463,337 bytes')
  && now.includes('fast-forward 154 commits beyond remote PR #258 head `338b6fd`')
