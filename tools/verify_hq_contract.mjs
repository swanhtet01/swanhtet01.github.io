...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `920c13d`')
  ...
  && workboard.includes('| ENG-077 | Website + Product Engineering Codex | ready |')
  ...
  && workboard.includes('Keep product checkpoint `920c13d`')
  && workboard.includes('Execute ENG-077 next')
  && now.includes('Current local checkpoints: product `920c13d`')
  ...
  && now.includes('Shop and Plant foundations each pass 11 focused tests plus 24 and 25 browser-model checks')
  && now.includes('Plant execution are 27,160- and 41,075-byte on-demand chunks')
