...
requireContract('portfolio is current',
  portfolio.updatedAt === '2026-07-29'
  && now.includes('Updated: 2026-07-29')
  && current.includes('Last confirmed: 2026-07-29'))
...
requireContract('accepted core checkpoints lead directly to real work',
  ...
  && now.includes('four direct samples open and paired brand/catalog identities match')
...
requireContract('Ally CEO execution uses one exact local-company run and no external action surface',
  ...
  && allyCeoLocalCycleText.includes("EXECUTION_SPEC_VERSION = '2026-07-29.19'")
  && allyCeoLocalCycleText.includes("LEGACY_EXECUTION_SPEC_VERSIONS = Object.freeze(['2026-07-29.18', '2026-07-29.17', '2026-07-29.16', '2026-07-29.15', '2026-07-29.14', '2026-07-29.13', '2026-07-29.12', '2026-07-29.11', '2026-07-29.10'])")
  ...
  && allyCeoLocalCycleText.includes("status: 'period_complete'")
  ...
  && allyCeoLocalCycleText.includes("'--num-predict', '768'")
...
requireContract('current CEO platform evidence is recorded without expanding authority',
  ...
  && now.includes('with no process stops; zero models remain and dispatch stays blocked on memory pressure'))
