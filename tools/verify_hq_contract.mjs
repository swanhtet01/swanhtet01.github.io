...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `5d7b217`')
  ...
  && workboard.includes('Keep product checkpoint `5d7b217`')
  && workboard.includes('current 210-commit local product delta')
  && now.includes('Checkpoint `5d7b217` is the accepted local product')
  ...
  && now.includes('largest JavaScript chunk is 463,892 bytes')
