...
requireContract('CEO four-product and innovation goal is explicit',
  ...
  && ceoProductGoal.includes('Preserve the proven mobile Ecommerce-to-Shop journey, Shop sale-to-fulfilment-to-close at both viewports, and Plant reviewed-import-to-output-to-quality-close at both viewports')
...
requireContract('route quality report preserves current evidence and production caveat',
  ...
  && productQualityReport.includes('five browser workflow gates')
  && productQualityReport.includes('43 deterministic checkpoints')
