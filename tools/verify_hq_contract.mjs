...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `0a2c4fb`')
  ...
  && workboard.includes('Keep product checkpoint `0a2c4fb`')
  && workboard.includes('current 202-commit local product delta')
  && now.includes('Checkpoint `0a2c4fb` is the accepted local product')
  ...
  && now.includes('fast-forward 156 commits beyond remote PR #258 head `338b6fd`')
