...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `0a57858`')
  ...
  && now.includes('Current local checkpoints: product `0a57858`')
  ...
  && now.includes('Product checkpoint `0a57858` is on a clean fast-forward descendant')
