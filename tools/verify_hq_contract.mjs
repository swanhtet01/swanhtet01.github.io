...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `da63602`')
  ...
  && workboard.includes('Keep product checkpoint `da63602`')
  && workboard.includes('current 196-commit local product delta')
  && now.includes('Checkpoint `da63602` is the accepted local product')
  ...
  && now.includes('largest JavaScript chunk is 463,280 bytes')
  && now.includes('fast-forward 150 commits beyond remote PR #258 head `338b6fd`')
