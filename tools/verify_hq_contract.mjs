...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `0d62b3c`')
  ...
  && now.includes('Current local checkpoints: product `0d62b3c`')
  ...
  && now.includes('Product checkpoint `0d62b3c` is on a clean fast-forward descendant')
