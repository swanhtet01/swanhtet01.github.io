...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `6857fad`')
  ...
  && now.includes('Current local checkpoints: product `6857fad`')
  ...
  && now.includes('Product checkpoint `6857fad` is on a clean fast-forward descendant')
