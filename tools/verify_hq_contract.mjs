...
requireContract('accepted core checkpoints lead directly to real work',
  ...
  && now.includes('PRs #267/#268 make Website finish in one standalone download')
...
requireContract('release history is retained and current live state is discoverable',
  ...
  && now.includes('Both `supermega.dev` and `app.supermega.dev` serve exact commit `e18fc6bc`'))
requireContract('workboard release authority and active execution order are current',
  ...
  && workboard.includes('Current accepted release checkpoint: `e18fc6bc8f392e398dfb89a8efa152b69ac8550d`')
