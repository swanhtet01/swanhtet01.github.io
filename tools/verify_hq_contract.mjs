...
requireContract('agent security brief is reconciled to current controls',
  ...
  && agentSecurity.includes('Bind managed purchase-order cancellation proof to the authenticated human')
...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `ac67088`')
  ...
  && now.includes('Current local checkpoints: product `ac67088`')
  ...
  && now.includes('Product checkpoint `ac67088` is on a clean fast-forward descendant')
