...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `aed737a`')
  ...
  && now.includes('Current local checkpoints: product `aed737a`')
  ...
  && now.includes('up to 12 pasted BOM materials')
  && now.includes('one manifest-backed smart import')
  && now.includes('Product checkpoint `aed737a` is on a clean fast-forward descendant')
