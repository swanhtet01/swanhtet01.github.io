...
requireContract('agent roster consolidation is recorded',
  ...
  && workboard.includes('Current accepted agent-operations checkpoint: `b46c386`')
  && now.includes('agent operations `b46c386`')
  && now.includes('operations `63a245f`')
  && now.includes('An unchanged direct mission reuses its evidence-bound report for 24 hours')
  && now.includes('inherited YTF connector identities cannot render in SuperMega operations')
