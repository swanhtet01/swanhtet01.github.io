...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `03e1f1b`')
  ...
  && workboard.includes('| ENG-078 | Ecommerce + Commerce Engineering Codex | ready |')
  ...
  && workboard.includes('Keep Website checkpoints `0f3dc09` and `03e1f1b`')
  && workboard.includes('Execute ENG-078 next')
  && now.includes('Current local checkpoints: product `03e1f1b`')
  ...
  && now.includes('Shop, Plant, and Website foundations pass 11, 11, and 13 focused tests plus 24, 25, and 23 browser-model checks')
  && now.includes('Website release are 27,160-, 41,075-, and 31,770-byte on-demand chunks')
  && now.includes('largest JavaScript chunk is 476,450 bytes')
