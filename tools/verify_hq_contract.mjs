...
requireContract('agent security brief is reconciled to current controls',
  ...
  && agentSecurity.includes('Audit managed Shop order pricing and tax boundaries')
...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `9989ac9`')
  ...
  && now.includes('Current local checkpoints: product `9989ac9`')
  ...
  && now.includes('Product checkpoint `9989ac9` is on a clean fast-forward descendant')
