...
requireContract('accepted core checkpoints lead directly to real work',
  workboard.includes('Current accepted product checkpoint: `793dd0e`')
  ...
  && now.includes('Current local checkpoints: product `793dd0e`')
  ...
  && now.includes('Product checkpoint `793dd0e` is on a clean fast-forward descendant')
