...
requireContract('current CEO platform evidence is recorded without expanding authority',
  ...
  && now.includes('released 2,190.5 MB without process stops; admission reopened at 82.2% RAM')
  && now.includes('one frontend, one backend, one idle worker, zero loaded models, zero configured local subagents'))
