...
requireContract('accepted core checkpoints lead directly to real work',
  ...
  && now.includes('Current checkpoints: product `17b458f`, release `2930ecf`')
...
requireContract('release history is retained and current live state is discoverable',
  ...
  && now.includes('Both `supermega.dev` and `app.supermega.dev` serve exact commit `2930ecfc2d29cc73310e27a2a73f5ac87aa29da8`'))
requireContract('workboard release authority and active execution order are current',
  ...
  && workboard.includes('Current accepted release checkpoint: `2930ecfc2d29cc73310e27a2a73f5ac87aa29da8`')
