...
requireContract('accepted core checkpoints lead directly to real work',
  ...
  && now.includes('Current local checkpoints: product `62a2fdf`')
  ...
  && now.includes('Product checkpoint `62a2fdf` is on a clean fast-forward descendant')
  && now.includes('Managed Shop Stock now persists reviewed two-location/lot setup')
