...
requireContract('agent roster consolidation is recorded',
  ...
  && workboard.includes('Current accepted agent-operations checkpoint: `07dd959`')
  && now.includes('agent operations `07dd959`')
...
requireContract('agent security brief is reconciled to current controls',
  agentSecurity.includes('Agent-operations checkpoint: `07dd959`')
  ...
  && agentSecurity.includes('Add one provider-neutral, read-only managed-storage privacy verifier')
