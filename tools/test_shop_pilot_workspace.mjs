...
const REQUIRED_TESTS = [
  'renders a private mobile Spa workspace intake starter with every authority closed',
  'starts and verifies a blank private Spa intake workspace without client data',
