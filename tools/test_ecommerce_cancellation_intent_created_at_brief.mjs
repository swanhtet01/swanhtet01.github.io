...
const bundle = await build({
  stdin: {
    contents: `export { projectEcommerceCancellationIntentCreatedAtBrief } from './ecommerce-cancellation-intent-created-at-brief.ts'`,
...
const { projectEcommerceCancellationIntentCreatedAtBrief } = await import(
...
let intentId = 0
function cancellationIntent(createdAt = '2026-08-01T09:00:00Z') {
  intentId++
  return {
...
// 1. Empty state
{
  const r = projectEcommerceCancellationIntentCreatedAtBrief(state())
...
{
  const r = projectEcommerceCancellationIntentCreatedAtBrief(state([
    cancellationIntent('2026-08-01T09:00:00Z'),
  ]))
...
{
  const r = projectEcommerceCancellationIntentCreatedAtBrief(state([
    cancellationIntent('2026-08-05T08:00:00Z'),
    cancellationIntent('2026-08-05T16:00:00Z'),
  ]))
...
{
  const r = projectEcommerceCancellationIntentCreatedAtBrief(state([
    cancellationIntent('2026-07-25T00:00:00Z'),
    cancellationIntent('2026-08-01T00:00:00Z'),
  ]))
...
{
  const r = projectEcommerceCancellationIntentCreatedAtBrief(state([
    cancellationIntent('2026-08-10T08:00:00Z'),
    cancellationIntent('2026-08-02T12:00:00Z'),
    cancellationIntent('2026-08-06T15:00:00Z'),
  ]))
...
{
  const r = projectEcommerceCancellationIntentCreatedAtBrief(state([
    cancellationIntent('2026-08-08T00:00:00Z'),
    cancellationIntent('2026-08-08T00:00:00Z'),
  ]))
...
console.log(`ecommerce-cancellation-intent-created-at-brief: ${checks} checks passed`)
