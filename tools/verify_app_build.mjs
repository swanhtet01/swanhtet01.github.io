...
if (!productHomeReadinessSource.includes('const launchReadinessRows = [')
  ...
  || !productHomeReadinessSource.includes('Free imports products and reviews orders locally.')
  || !productHomeReadinessSource.includes('Premium adds MES, MRP, ISO, roles, and cost handoff.')
  || !productHomeReadinessSource.includes('Premium scales shared roles, import checks, approvals, evidence export, and AI context across branches.')
