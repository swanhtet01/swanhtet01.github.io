...
if (!ecommerceSource.includes('const orderOpsRows = [')
  ...
  || !ecommerceSource.includes("type OrderImportReview =")
  || !ecommerceSource.includes("const ORDER_IMPORT_REVIEW_PACKET_SCHEMA = 'supermega.ecommerce.order_import_review_packet.v1' as const")
  || !ecommerceSource.includes('const orderImportForbiddenActions = [')
  || !ecommerceSource.includes("const [orderImportText, setOrderImportText] = useState('')")
  || !ecommerceSource.includes('const [orderImportReview, setOrderImportReview] = useState<OrderImportReview | null>(null)')
  ...
  || !ecommerceSource.includes('schema: ORDER_IMPORT_REVIEW_PACKET_SCHEMA')
  || !ecommerceSource.includes('forbiddenActions: [...orderImportForbiddenActions]')
