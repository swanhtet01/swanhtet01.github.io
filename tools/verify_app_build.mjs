...
if (!coreSource.includes("{ to: '/', label: 'Home', end: true }")
  ...
  || coreSource.includes("{ to: '/work/', label: 'HQ'")
  || coreSource.includes("{ to: '/operations/', label: 'Products'")) fail('first_run_navigation_not_simple')
const productHomePageContract = coreSource.slice(coreSource.indexOf('const customerTracks'), coreSource.indexOf('function ApprovalReviewDialog'))
if (!productHomePageContract.includes('title="Choose a product. Run work."')
  ...
  || !productHomePageContract.includes("'/ecommerce/'")
  || !productHomePageContract.includes('clientSetupPath(product)')
