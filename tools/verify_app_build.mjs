...
if (!settingsPageSource.includes('const learningRows = [')
  ...
  || !settingsPageSource.includes('schedulerActivation: runtime.schedulerActivation')
...
if (!coreSource.includes('const authReady = Boolean(body.authentication?.trusted_gateway_ready || body.authentication?.supabase_user_tokens_ready)')
  ...
  || !coreSource.includes('schedulerActivation,')
  || !coreSource.includes('activationEvidenceContract')
  || !coreSource.includes('queueJobTypes')
