...
if (!coreSource.includes('const shopProcurementRows = [')
  ...
  || !coreSource.includes('No supplier message, payment, receipt, stock, costing, or accounting write runs from this panel.')) fail('shop_procurement_readiness_missing')
