...
if (!websiteModelSource.includes('releaseRecords?: WebsiteReleaseState[]')
  || !websiteSource.includes("managedReleaseRecords={storageMode === 'managed' ? workspace.releaseRecords ?? [] : undefined}")
  || !websiteSource.includes("onSaveManagedRelease={storageMode === 'managed' ? saveManagedRelease : undefined}")
