...
if (!productHomePageContract.includes('title="Choose what you want to run."')
  || !productHomePageContract.includes('className="product-home-grid"')
  || !productHomePageContract.includes("path: '/shop/'")
  || !productHomePageContract.includes("path: '/plant/'")
  || !productHomePageContract.includes("path: '/website/'")
  || !productHomePageContract.includes("path: '/ecommerce/'")
  || !productHomePageContract.includes('to={product.path}')
