...
if (!settingsPageSource.includes('const learningRows = [')
  ...
  || !settingsPageSource.includes('version: 13')
...
if (!appSource.includes("demo === 'shop' || demo === 'retail'")
  ...
  || !appSource.includes('return <Navigate replace to="/shop/" />')
  || !appSource.includes('return <Navigate replace to="/plant/" />')
  || !appSource.includes('return <Navigate replace to="/website/" />')
  || !appSource.includes('return <Navigate replace to="/ecommerce/" />')) fail('canonical_demo_query_routes_missing')
