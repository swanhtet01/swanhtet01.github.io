...
if (!productHomePageContract.includes('title="Pick a track. Run work."')
  ...
  || !productHomePageContract.includes("name: 'Retail'")
  || !productHomePageContract.includes("name: 'Factory MES'")
  || !productHomePageContract.includes("name: 'Website catalog'")
  || !productHomePageContract.includes("name: 'Online orders'")
  || !productHomePageContract.includes('Handled by SuperMega')
  || !productHomePageContract.includes('Approved by owner')
  || !productHomePageContract.includes("path: '/shop/?tab=counter'")
  || !productHomePageContract.includes("path: '/plant/?tab=production'")
  || !productHomePageContract.includes("path: '/ecommerce/'")
  || !productHomePageContract.includes("setupPath: clientSetupPath('commerce')")
  || !productHomePageContract.includes("setupPath: clientSetupPath('production')")
  || !productHomePageContract.includes("setupPath: clientSetupPath('website')")
  || !productHomePageContract.includes("setupPath: clientSetupPath('ecommerce')")
  || !productHomePageContract.includes('className="product-track-grid"')
  || !productHomePageContract.includes("path: '/website/'")
