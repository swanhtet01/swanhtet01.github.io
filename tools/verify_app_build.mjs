...
if (!settingsPageSource.includes('const learningRows = [')
  ...
  || !settingsPageSource.includes('version: 12')
...
if (!coreSource.includes('const authReady = Boolean(body.authentication?.trusted_gateway_ready || body.authentication?.supabase_user_tokens_ready)')
  ...
  || !coreSource.includes('enterprise_activation?: { requirements?: string[]; steps?: RuntimeActivationStep[] }')
  ...
  || !coreCssSource.includes('.activation-runbook-steps')) fail('managed_activation_gates_not_visible')
