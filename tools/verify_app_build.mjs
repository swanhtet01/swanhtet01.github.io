...
if (!coreSource.includes('const plantRows = [')
  ...
  || !coreSource.includes('AI guides plan, execution, quality, WCM, traceability, and handoff from one Plant record.')
  || !coreSource.includes('No equipment command or production write runs without owner approval.')
  ...
  || !coreSource.includes('Owner confirms every production, quality, WCM, maintenance, material, and shift-handoff write before Plant changes.')
...
if (!coreSource.includes('const shopOrderLifecycleRows = [')
  ...
  || !coreSource.includes('AI guides capture, reservation, fulfilment, collection, replenishment, and returns from one Shop record.')
  || !coreSource.includes('Owner confirms every order, payment, refund, delivery, cancellation, and stock write.')) fail('shop_order_lifecycle_missing')
...
if (!commercePageContract.includes('const shopOrderControlNext = orderDraftRecoveryBlocked')
  ...
  || !commercePageContract.includes('Owner confirms every order, payment, refund, delivery, cancellation, and stock change before Shop writes.')
