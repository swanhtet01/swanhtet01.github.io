...
if (!coreCssSource.includes('.product-home-autopilot')
  ...
  || !coreCssSource.includes('.product-home-autopilot-grid { grid-template-columns: 1fr; }')) fail('first_run_operating_plan_responsive_ui_missing')
if (!settingsPageSource.includes('const learningRows = [')
  ...
  || !settingsPageSource.includes('version: 18')
