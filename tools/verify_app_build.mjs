...
for (const required of ['SUPERMEGA', 'Shop', 'Plant', 'Website', 'Ecommerce', 'Orders', 'Stock', 'Purchase orders', 'Jobs', 'Quality', 'Maintenance', 'Content', 'Preview', 'Publish', 'Catalog', 'Storefront', 'Requests', 'Sample workspace', 'Start guided sample', 'Request managed trial', 'Trial setup', 'Confirm change', 'Action history', 'actorKind', 'evidenceReference', 'accountableActions', 'Operating mode', 'Write path', manifest.brand.colors.accent, manifest.brand.colors.ink]) {
...
if (!coreSource.includes('if (started) return null')
...
if (!productHomePageContract.includes('title="Start with one product."')
  ...
  || !productHomePageContract.includes("setupProduct: 'commerce' as const")
  || !productHomePageContract.includes("setupProduct: 'production' as const")
  || !productHomePageContract.includes("setupProduct: 'website' as const")
  || !productHomePageContract.includes("setupProduct: 'ecommerce' as const")
  || !productHomePageContract.includes('to={clientSetupPath(product.setupProduct)}')
...
if (!ecommerceSource.includes('Prices and stock stay controlled by Shop.')
  ...
  || !ecommerceSource.includes('Choose Shop products, preview the customer experience, and hand one reviewed quote to Shop.')
...
if (addToCartStart < 0
  ...
  || !addToCartAction.includes('catalogHydrating || !savedDraftIsCurrent')
