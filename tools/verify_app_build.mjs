...
if (!coreSource.includes("lazy(() => import('./ClientDataOnboarding')")
  ...
  || !clientOnboardingUiSource.includes('Preview sample data')
  ...
  || !clientOnboardingUiSource.includes('ambiguous columns wait for your choice')
  ...
  || !clientOnboardingUiSource.includes('Download checked import')
