...
if (!ecommerceSource.includes('const orderOpsRows = [')
  ...
  || !ecommerceCssSource.includes('.ecommerce-payment-delivery-cockpit')) fail('ecommerce_order_ops_cockpit_missing')
...
const prepareQuoteRecoveryEnd = ecommerceSource.indexOf('async function recordManagedBuyingRequest', prepareQuoteRecoveryStart)
