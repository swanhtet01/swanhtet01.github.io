...
if (!settingsPageSource.includes('const learningRows = [')
  ...
  || !settingsPageSource.includes('evidenceVersion: 22')
  ...
  || !settingsPageSource.includes('version: 22')
...
if (!coreSource.includes('const authReady = Boolean(body.authentication?.trusted_gateway_ready || body.authentication?.supabase_user_tokens_ready)')
  ...
  || !coreSource.includes('manifest?: RuntimeActivationManifest')
  ...
  || !coreSource.includes('enterprise_activation?: { requirements?: string[]; steps?: RuntimeActivationStep[]; evidence_plan?: RuntimeEvidencePlanItem[]; manifest?: RuntimeActivationManifest }')
