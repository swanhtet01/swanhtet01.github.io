...
if (!appLiveVerifierSource.includes('AI command queue')
  ...
  || !appLiveVerifierSource.includes('Shop, Plant, Website, and Ecommerce stay separate apps but share one evidence and approval system.')) fail('live_verifier_missing_ai_command_queue_contract')
