...
if (coreSource.includes('Math.min(quantity') || !productionPageContract.includes('Nothing was recorded.') || !productionPageContract.includes('Number.isSafeInteger(quantity)') || !productionPageContract.includes('max={selectedRemaining}')) fail('production_output_limit_missing_or_silently_clamped')
