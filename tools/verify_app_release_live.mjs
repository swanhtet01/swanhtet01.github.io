...
export function verifyCurrentReleaseAssets({
  ...
  const groups = [
    ...
    ['guided_outcomes', productOnboardingChunk, ['Complete a first counter sale', 'Open Shop Sell', 'Run a sample production job', 'Create Plant and open the job', 'Preview a business website', 'Create Website and preview it', 'Open a working online store', 'Build Ecommerce from Shop']],
