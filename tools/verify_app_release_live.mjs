...
for (const required of ['AI command queue', 'One queue tells the owner what to do next.', 'SuperMega ranks setup, import, product work, managed activation, and learning handoff into safe next actions.', 'it does not send, publish, charge, move stock, write production, or train models from this queue.', 'Finish setup', 'Export evidence', 'Operate products', 'Shop, Plant, Website, and Ecommerce stay separate apps but share one evidence and approval system.', 'Business starter tracks', 'Pick the business type. SuperMega picks the modules.', 'Clients should not learn every enterprise feature on day one.', 'Retail or distributor', 'Factory or workshop', 'Service or local brand', 'Multi-branch operator', 'Start with product CSV, stock counts, online order CSV, and payment review proof.', 'Start with job CSV, material list, quality holds, maintenance evidence, and stock issue proof.', 'Start with business facts, offer proof, photos, catalog rows, and channel order samples.', 'Start with one branch pack, role list, import samples, approval receipts, and shared evidence export.', 'Free proof', 'Local enterprise max', 'Premium unlock', 'Managed AI context', 'First sale motion', 'Prepared template demo', 'Operator promise', 'Minimal controls', 'Upload or paste sample data, run the AI queue, export evidence, and prove value without managed writes.', 'Activate tenant roles, audit, branch data, approved learning, hosted scheduler, and write gates after review.', 'Track launch pack actions', 'Retail launch pack', 'Factory launch pack', 'Brand launch pack', 'Branch launch pack', 'Prepare data', 'Open workspace', 'agent_job_chosen', 'Choose track', 'AI operating tracks', 'Separate products, one simple operating model.', 'AI inventory operator', 'AI MES coordinator', 'AI site builder', 'AI order desk', 'Launch readiness', 'Free proves value. Premium activates controls.', 'Use Activation handoff', 'Premium can learn only from approved data and behavior memory.', 'Open activation']) {
...
for (const required of ['Load sample brief', 'Mingalar Fresh Mart', 'families and office buyers in Yangon', 'Daily groceries, pantry packs, and local delivery with clear pickup windows.', 'Owner-approved public proof: same-day neighborhood delivery, visible prices, and a reviewed phone or chat contact route.', 'Website starter brief generated']) {
