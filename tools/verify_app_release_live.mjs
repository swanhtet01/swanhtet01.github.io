...
for (const required of ['supermega.pilot_outcome_report.v1', 'Free outcome proof', 'Prove one result from real', 'Start proof run', 'Accept measured result', 'Download accepted proof', 'Aggregate counts only. No raw records', 'Named-owner acceptance and its exact decision proof were saved.', 'Accept the measured', 'local://pilot-outcome/', 'no raw records or external writes were included.', 'Storefront not saved,', 'shop-guided-sale-gap', 'Guided Shop sale gap', 'owner-confirmed guided counter sale', 'Start Shop outcome proof', 'plant-guided-output-gap', 'Guided Plant output gap', 'named-owner good-output record', 'Start Plant outcome proof', 'Confirm one good-output result with named-owner shift evidence.', 'One confirmed shift output']) {
