...
export function verifyCurrentReleaseAssets({
  ...
  const groups = [
    ...
    ['onboarding', productOnboardingChunk, ['Save your own workspace', 'Enter one business name. We will open a working copy with sample records.', 'This setup affects', 'Opening it will not run setup again.', 'Nothing is sent or published.']],
    ...
    ['secondary_tools', productSystemNavigatorChunk, ['Next steps', 'More workflows or your data', 'Keep working in ', 'Choose another working flow, use your data, or ask us to set up ', 'https://supermega.dev/contact/?product=shop&utm_source=app&utm_medium=product&utm_campaign=working-sample', 'https://supermega.dev/contact/?product=plant&utm_source=app&utm_medium=product&utm_campaign=working-sample', 'https://supermega.dev/contact/?product=website&utm_source=app&utm_medium=product&utm_campaign=working-sample', 'https://supermega.dev/contact/?product=ecommerce&utm_source=app&utm_medium=product&utm_campaign=working-sample', ' for my business', 'Your data', 'Upload a CSV or try a sample.', 'Use my Shop data', 'Use my Plant data', 'Use my website content', 'Use my store data', 'Only ', 'next_steps_opened', 'data_setup_opened', 'product_requested']],
