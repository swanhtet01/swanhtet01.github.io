...
export function verifyCurrentReleaseAssets({
  ...
  const groups = [
    ...
    ['onboarding', productOnboardingChunk, ['Save your own workspace', 'Enter one business name. We will open a working copy with sample records.', 'This setup affects', 'Opening it will not run setup again.', 'Nothing is sent or published.', 'Need help bringing real data?', 'Ask SuperMega to set up ', 'product_requested']],
