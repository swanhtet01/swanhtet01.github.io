...
for (const required of ['Plant agent queue', 'Recommended Plant agent job', 'Agent job', 'Owner gate', 'Record next job output', 'Contain urgent Plant problems', 'Review quality holds', 'Close WCM records', 'Build shift handoff', 'Plant control', 'Contain urgent problems', 'Close WCM work', 'MES lifecycle', 'Plan to handoff', 'AI guides plan, execution, quality, WCM, trace, and handoff.', 'No equipment or production write runs without owner approval.', 'MRP readiness', 'Plant MRP readiness', 'AI reviews job demand, BOM, availability, Shop supply, material blockers, and trace evidence.', 'No purchase, issue, costing, inventory, or production write runs from this panel.', 'Demand', 'BOM', 'Availability', 'Shop supply', 'Issue gate', 'Materials ready for review', 'Resolve material blockers', 'Check BOM shortfalls', 'Review Shop supply', 'Record first material use', 'Jobs', 'Quality', 'WCM', 'Materials', 'Handoff', 'Write gate', 'Plan', 'Execute', 'Trace', 'Owner confirms production, quality, WCM, maintenance, material, and handoff writes.']) {
