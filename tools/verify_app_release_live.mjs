...
export function verifyCurrentReleaseAssets({
  ...
  const groups = [
    ...
    ['guided_outcomes', productOnboardingChunk, ['Complete a first counter sale', 'Open Shop Sell', 'Record output for a first production job', 'Open Plant Jobs', 'Preview a business website', 'Create Website and preview it', 'Open a working online store', 'Build Ecommerce from Shop']],
    ['onboarding', productOnboardingChunk, ['Make ', ' yours', 'One step', 'Quick setup', 'Name your workspace', 'Bring the production jobs you actually plan to run. Industry demo records stay optional.', 'We will add a realistic website draft now; replace it with your content whenever you are ready.', 'First useful result:', 'Open Jobs with ', 'Industry demo is optional', 'Demo production type', 'Enter a business name to continue.', 'This setup affects', 'Opening it will not run setup again.', 'Nothing is sent or published.', 'Need help bringing real data?', 'Ask SuperMega to set up ', 'product_requested']],
    ['shop_plant', operationsChunk, ['Create order', 'Finish payment and handoff in Orders.', 'Stock reserved. Finish fulfilment and reconcile payment before completion.', 'Local workspace', 'Business data stays on this device.', 'Browser-local business workspace.', 'Local production plan', 'reviewed business job', 'Local business records on this device', 'Built-in Plant sample', 'Jobs', 'Problems', 'Record output', 'Close shift', 'Browser-local sample only.', 'No payment is captured']],
