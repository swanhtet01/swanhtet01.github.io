...
export function verifyCurrentReleaseAssets({
  ...
  const groups = [
    ['launcher', assetCorpus, ['SUPERMEGA', 'Switch product', 'Working samples. Add data when ready.', 'supermega.last-product.v1', 'Sell + stock', 'Produce', 'Build site', 'Order page', 'Sales, orders, stock, close.', 'Jobs, materials, quality.', 'Pages, leads, preview.', 'Storefront to Shop handoff.', 'Samples stay separate.', 'Open', manifest.brand.colors.accent, manifest.brand.colors.ink]],
