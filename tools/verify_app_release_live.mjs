...
for (const required of ['supermega.pilot_outcome_report.v1', 'Free outcome proof', 'Prove one result from real', 'Start proof run', 'Accept measured result', 'Download accepted proof', 'Aggregate counts only. No raw records', 'New product evidence will reopen the proof.', 'Storefront not saved,']) {
