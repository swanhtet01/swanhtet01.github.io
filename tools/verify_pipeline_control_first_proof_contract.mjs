...
assert.equal(action.first_proof.pilot_order_room.private_workspace_manifest.status, 'private_workspace_created')
assert.equal(action.first_proof.pilot_order_room.private_workspace_manifest.create_workspace_allowed, true)
assert.equal(action.first_proof.pilot_order_room.private_workspace_manifest.workspace_created, true)
...
assert.ok(action.first_proof.pilot_order_room.private_workspace_manifest.workspace_url.startsWith('https://supermega.dev/app/start?'))
assert.ok(action.first_proof.pilot_order_room.private_workspace_manifest.workspace_url.includes('workspace=pilot-daily-intelligence-brief-lead-test123'))
assert.ok(action.first_proof.pilot_order_room.private_workspace_manifest.workspace_url.includes('lead=LEAD-TEST123'))
...
assert.ok(action.first_proof.pilot_order_room.private_workspace_handoff_packet.includes('Workspace created: yes'))
