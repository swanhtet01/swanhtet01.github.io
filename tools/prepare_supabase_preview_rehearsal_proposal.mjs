...
const EXPECTED_PRIVATE_MIGRATION_COUNT = 18
const EXPECTED_PUBLIC_BASELINE = '20260711081300_public_legacy_baseline.sql'
const EXPECTED_FINAL_MIGRATION = '20260918011500_website_customer_acceptance.sql'
...
function validateProposalShape(packet) {
  ...
  for (const evidence of [
    ...
    'website-acceptance-exact-revision-idempotency-and-decision-race-proof',
    'website-acceptance-nonempty-backup-restore-and-no-publication-authority',
