...
requireContract('ordered integration batches preserve production safeguards and candidate product depth',
  ...
  && releaseIntegrationBatch.includes("title=\"Switch product\"")
  && releaseIntegrationBatch.includes('Each product opens as its own working sample. Setup is optional when you are ready to use your business data.')
  && releaseIntegrationBatch.includes('.product-track-grid { display: grid; grid-template-columns: repeat(2,minmax(0,1fr)); gap: 10px; }')
