...
requireContract('ordered integration batches preserve production safeguards and candidate product depth',
  ...
  && releaseIntegrationBatch.includes('managed schema contract advances through additive v2 through v9 migrations')
  && releaseIntegrationBatch.includes('all ten migrations as `postgres`')
