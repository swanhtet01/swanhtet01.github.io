...
function selfTestPacket() {
  ...
  const packet = {
    ...
    gates: [
      ...
      gateStatus({ id: 'review_branch_push', label: 'Review branch push', status: 'blocked', blockers: ['github_main_protection_unverified'], approvalEnv: 'SUPERMEGA_REVIEW_BRANCH_PUSH_APPROVAL', digest: fakeDigest('2') }),
