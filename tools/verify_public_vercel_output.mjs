...
for (const token of ['buildSolutionRoute', 'autopilot_solution_router', 'solution_route', 'buildImplementationBlueprintPack', 'implementation_blueprint_pack', 'buildIntakeJob', 'intake_to_first_proof', 'intake_job', 'buildClientKickoffPack', 'client_kickoff_pack', 'buildContactSourcePackRequest', 'source_pack_request_ready', 'client_source_pack_intake', 'buildOwnerOnboardingAlert', 'owner_onboarding_alert', 'ai_workcell_source_pack_room', '/app/source-pack?', 'buildFirstProofTaskPayload', 'first_proof_task', 'lead: {', 'owner approval before send/write/payment actions', 'supermega-blob-queue', 'blob_action_queue', 'New setup lead -', 'Source pack room:', 'Operator:', 'entitlement_free_core', 'entitlement_paid_pilot', 'entitlement_premium', 'entitlement_gated_hands', 'entitlement_gate']) {
