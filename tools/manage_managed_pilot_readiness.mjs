...
const sources = [
  ...
  'hq/readiness/hosted-storage-privacy-proof.json',
  'hq/readiness/managed-persistence-proof.json',
  'hq/readiness/self-serve-pilot-proof.json',
  'hq/NOW.md',
  'package.json',
...
async function currentLedger() {
  ...
  return buildManagedPilotReadiness({
    ...
    selfServePilotEvidence: JSON.parse(texts.get('hq/readiness/self-serve-pilot-proof.json')),
