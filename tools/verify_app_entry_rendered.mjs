...
const tests = [
  ...
  },
  {
    ...
    expectedPath: (path) => path.startsWith('/ecommerce/'),
    expectedPathLabel: '/ecommerce/',
    expectedText: ['Ecommerce', 'Sample request saved locally', 'This sample order request is saved on this device for Shop review.', 'This browser demo retained the request.'],
