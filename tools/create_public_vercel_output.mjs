...
function canonFounderLockedProductNames(content) {
  return String(content)
    .replace(/Document Extraction Ledger|Back Office Workflow Desk|Back Office AI Desk/g, 'AI Agent Solutions')
  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing:border-box; } body { margin:0; background:var(--paper); color:var(--ink); font:16px/1.55 system-ui,-apple-system,Segoe UI,sans-serif; }
      ...
      .plans { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:16px; margin-top:38px; } .plan { border:1px solid var(--line); padding:20px; background:white; } .plan.premium { border-color:var(--accent); } .plan h3 { margin:0 0 8px; font-size:22px; } .plan p { font-size:15px; } .plan ul { margin:14px 0 0; padding-left:18px; color:var(--muted); font-size:14px; }
  ...
  <body>
    <main class="page" data-social-destination="ai-agent-solutions">
      ...
      <section class="plans" aria-label="AI machine plans">
        ...
        <article class="plan premium"><div class="eyebrow">Premium context</div><h3>Make it remember how your business works.</h3><p>Add persistent approved context and scheduled workers so each run becomes more relevant without training on private data.</p><ul><li>Persistent company context</li><li>Scheduled monitoring and follow-ups</li><li>Source-change history and outcome learning</li><li>Connector setup, audit trail, and managed support</li></ul></article>
      </section>
