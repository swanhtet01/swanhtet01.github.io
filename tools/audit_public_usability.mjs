  ...
  for (const viewport of [
    ...
    const operator = await page.evaluate(() => {
      ...
      return {
        ...
        hasSalesAutopilotDraftRenderer: html.includes('salesAutopilotDraft') && html.includes('Autopilot draft artifact') && html.includes('Copy autopilot draft'),
        hasAutopilotCommandRenderer: html.includes('renderAutopilotCommandBoard') && html.includes('Autopilot command board') && html.includes('Copy autopilot command queue') && html.includes('Copy autopilot daily brief'),
