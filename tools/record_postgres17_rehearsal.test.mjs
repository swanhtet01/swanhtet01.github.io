...
const checkNames = [
  ...
  'managed_exact_retry', 'managed_human_attribution', 'managed_production_job_to_output', 'managed_website_to_commerce_journey',
...
const implementation = { digest: `sha256:${'a'.repeat(64)}`, fileCount: 24 }
const context = {
...
const raw = {
  ...
  migrations: { count: 6, schema_version: 5, production_validator_ready: true },
  ...
  recovery: { backup_nonempty: true, format: 'pg_dump_custom', restored_schema_version: 5 },
