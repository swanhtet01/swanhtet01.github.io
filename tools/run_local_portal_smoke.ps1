...
function Assert-LegacySmokeApproval {
    ...
    Write-Warning "Running legacy serve_solution.py / mark1_pilot portal smoke only. This is not SuperMega readiness proof, release proof, commercial proof, or Shop pilot evidence."
}
