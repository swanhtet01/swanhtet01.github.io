...
test('prepare two exact clean isolated sources with digest and no external authority', () => {
  ...
  assert.equal(result.controls.localWorktreesCreated, 2)
  for (const [key, value] of Object.entries(result.controls)) if (key !== 'localWorktreesCreated') assert.equal(value, false, key)
