...
2. Apply `supabase/migrations/20260722005134_private_trial_backend_foundation.sql` and then `supabase/migrations/20260722142801_private_trial_backend_v2.sql` with an administrative migration connection. Never edit or replay the historical v1 migration, and never use the application runtime login for migrations. Runtime readiness requires schema version 2 plus its actor and decision-contract columns and constraints.
