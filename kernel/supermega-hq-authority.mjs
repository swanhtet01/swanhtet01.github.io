...
export const SUPERMEGA_HQ_AUTHORITY = Object.freeze({
  ...
  outcomes: Object.freeze([
    ...
    Object.freeze({
      ...
      objective: 'Compare the fixed lead, pipeline, and platform evidence across Shop, Plant, Website, and Ecommerce. Prefer a real workflow outcome over feature volume, state missing evidence plainly, and propose one measurable product decision. Do not change the roadmap or customer records.',
      blockers: Object.freeze([]),
      evidencePlan: Object.freeze([
