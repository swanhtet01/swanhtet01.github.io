...
revoke all on table public.supermega_token_ledger from public, anon, authenticated;
revoke all on table public.supermega_ai_budget_reservations from public, anon, authenticated;
...
revoke all on table public.supermega_action_queue from public, anon, authenticated;
...
grant select, insert, update on table public.supermega_token_ledger to service_role;
grant select, insert, update on table public.supermega_ai_budget_reservations to service_role;
...
grant select, insert, update, delete on table public.supermega_action_queue to service_role;
