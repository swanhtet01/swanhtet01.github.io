    ...
    products = [
        {
            ...
            "demo_route": "/examples#lead-to-pilot",
        ...
        },
        {
            ...
            "demo_route": "/examples#supplier-watch",
            "data_sources": ["Gmail", "forwarded emails", "manual pasted threads"],
            "next_build": "Connect directly to live supplier inboxes and escalation write-backs.",
        },
        {
            "id": "director-command-agent",
            "name": "Director Command Agent",
            "family": "showcase",
            "status": "live_demo",
            "promise": "Convert daily noise into one clear action and decision brief.",
            "best_for": "directors, founders, general managers",
            "demo_route": "/examples#director-command",
            "data_sources": ["ops updates", "team notes", "manager snippets"],
            "next_build": "Connect directly to role dashboards and approval flows.",
        },
        {
