...
def build_product_lab(config: PilotConfig, repo_root: Path | None = None) -> dict[str, Any]:
    ...
    products = [
        ...
        },
        {
            ...
            "family": "control_module",
            "status": "design_ready",
            "promise": "Turn shift and downtime updates into a daily execution board.",
            "best_for": "operations managers and plant leads",
            "demo_route": "",
            "data_sources": ["shift sheets", "downtime logs", "production notes"],
            "next_build": "Add plan-vs-actual tracking and recurring plant brief generation.",
        },
        {
            "id": "sales-signal",
            "name": "Sales Signal",
            "family": "control_module",
            "status": "design_ready",
            "promise": "Turn scattered market and distributor updates into one commercial watch layer.",
            "best_for": "commercial teams, directors, and founders",
            "demo_route": "",
            "data_sources": ["sales sheets", "distributor notes", "external watch"],
            "next_build": "Add price movement watch, channel trend tracking, and demand-shift alerts.",
        },
        {
            "id": "supermega-os",
            "name": "SuperMega OS",
