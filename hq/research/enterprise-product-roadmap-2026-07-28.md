...
2. **Shop control depth:** company/location account determination, correction settlement accounts, supplier debit/physical-return execution, customer-master credit limits and approval policy, warranty/service case, and an owner-approved duplicate-safe posting adapter.
