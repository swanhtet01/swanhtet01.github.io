...
1. **Founder activation decision** — the 4-step runbook (apply v11 → schema version env → open the activation window → enable writes; all but the last reversible). The remediation branch (#419) and its release (#420) are both merged to `main` as of 2026-08-17 — this precondition is satisfied.
