...
- Checkpoint `723c403` contains the accepted local Shop, Plant, Website, Ecommerce, and Order Intake work.
...
- Live: canonical domains serve `main` `6885c320`; local `723c403` is +111/+65 versus main/integration. Vercel's misnamed project still builds `swanhtet01.github.io` `3d1d9e32`. No external state changed.
...
- The canonical domains are 111 local commits behind this candidate; the similarly named Vercel project is linked to the wrong repository. Release actions remain owner-gated.
...
2. Review the 111-commit release-candidate delta, then obtain explicit owner approval before any push, merge, deployment, or canonical-domain correction.
