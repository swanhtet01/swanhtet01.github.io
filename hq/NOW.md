...
- 24 recoveries, exact supersession, stale-draft closure, replacement action, and replacement-submit clarity pass. Next: `shop-online-request-review-clarity`; pilots stay owner-gated.
...
- Codex is sole integrator. OPS-196 makes replacement intent explicit before submission on desktop/mobile while retaining exact lineage and zero business writes. CLAUDE-006 remains manual and read-only.
...
1. Complete `shop-online-request-review-clarity`: call an Ecommerce handoff a request until Shop confirms it, without changing order authority or adding a page.
