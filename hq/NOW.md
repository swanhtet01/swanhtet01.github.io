...
- Checks: 106 Ecommerce, 342 Commerce, 327 Production, 128 Shop next-action, 58 AR customer receivables, 109 Website, 95 security, 241 onboarding, 11 backup, 85 managed import, and 56 PostgreSQL 17 checks across eleven migrations. Shop next-action raised from 10 → 128 (all 9 decision paths, priority ordering, plural/singular, validation). AR receivables and Shop next-action both wired into app:verify.
