...
- Live HQ and both domains agree on `7333486e`; no release drift is present. Four hosted-readiness gates still block managed activation/marketing (hosted PG17, security, and storage privacy are ready-hosted); external handoffs require `release:handoff:verify`.
