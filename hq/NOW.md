...
- Plant maintenance binds active strategy and completion evidence, advances due only after review, and projects due work in one deterministic existing-dialog queue. It performs no dispatch, control, telemetry, or parts action.
