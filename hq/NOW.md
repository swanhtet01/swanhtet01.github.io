...
- OPS-253 resumes the exact Online request inbox after accountable location setup; New order and Sell keep their accepted destinations. Next: `shop-local-ecommerce-inbox-review`; pilots stay owner-gated.
...
1. Complete `shop-local-ecommerce-inbox-review`: show and safely review browser-local Ecommerce requests already counted by the local Shop inbox; keep managed identity boundaries unchanged.
