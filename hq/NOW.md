...
- OPS-272 (`5695a15c`) adds a privacy-minimal Spa invitation handoff and provider-result receipt with exact redirect/SMTP proof, no automatic retry, and fresh sign-in still required. No sender exists. Completion history: 120. Next: guarded server transport and isolated mobile role rehearsal.
...
- Codex is sole integrator. The 18-file, 56-check PostgreSQL 17 rehearsal passes at `5695a15c`; hosted invitation, activation, and mobile acceptance remain owner-gated. CLAUDE-009 remains owner-controlled.
