...
- OPS-252 resumes New order after accountable location setup; Sell still resumes a focused Counter. Next: `shop-required-scope-resume-online-entry`; pilots stay owner-gated.
...
1. Complete `shop-required-scope-resume-online-entry`: preserve pre-scope Online request intent while keeping the accepted New order and Sell destinations.
