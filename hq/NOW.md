...
- Codex is sole integrator. OPS-236 proves real Ecommerce customer help through Shop acknowledgement, response-readiness, resolution, one retained follow-up, and reload; no message is sent. CLAUDE-008 stays manual at `969fae03`.
...
1. Complete `ecommerce-real-order-correction-client-acceptance`: prove one completed real-catalog order through customer balance-review recovery, accountable Shop recalculation, correction evidence, and reload without changing the original invoice or moving money.
