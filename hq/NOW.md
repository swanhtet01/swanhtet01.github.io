...
- Both domains serve deployed `757cd3b64d0818d477e698235c58c4fbf34682c5`; paired brand, context, and catalog identities match, the scheduler ceiling is one job, and exact live verification passes. Both Vercel deployments are READY.
...
- Live HQ and both domains agree on `757cd3b6`; no release drift is present. Seven hosted-readiness gates still block managed activation/marketing; external handoffs require `release:handoff:verify`.
