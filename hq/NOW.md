...
- App/local gates pass: 309 Python tests, lint/build, 66 security checks, and a 472,542-byte largest chunk. Kernel passes 282 tests, 69 connectors/993 adversarial calls, and 15 crews/214 checks.
