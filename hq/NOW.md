...
- 27 recoveries/audits and all 32 Shop/16 Plant final actions pass. The newest overlapping Plant CSV now owns the local review. Next: `plant-job-import-field-length-parity`; pilots stay owner-gated.
...
- Codex is sole integrator. OPS-220 rejects stale Plant CSV success and failure results without creating records. CLAUDE-007 stays manual at `2744b28f`.
...
1. Complete `plant-job-import-field-length-parity`: align CSV validation with Job ID, line, product, and owner form limits.
