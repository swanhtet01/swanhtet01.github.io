...
- Checkpoint `d346340` contains the accepted local Shop, Plant, Website, Ecommerce, and Order Intake work.
...
- Rendered 375-390 px journeys prove required Shop fulfilment handoff, Plant's remaining-unit limit, Website recovery, and truthful Ecommerce status without overflow, browser errors, or pre-confirmation mutation.
...
- Live: canonical domains serve `main` `6885c320`; local `d346340` is +113/+67 versus main/integration. Vercel's misnamed project still builds `swanhtet01.github.io` `3d1d9e32`. No external state changed.
...
- The canonical domains are 113 local commits behind this candidate; the similarly named Vercel project is linked to the wrong repository. Release actions remain owner-gated.
...
2. Review the 113-commit release-candidate delta, then obtain explicit owner approval before any push, merge, deployment, or canonical-domain correction.
