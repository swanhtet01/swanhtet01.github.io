...
- 24 recoveries, exact supersession, replacement lineage, stale-draft closure, and replacement focus/action pass. Next: `ecommerce-replacement-submit-clarity`; pilots stay owner-gated.
...
- Codex is sole integrator. OPS-195 proves the focused `Open replacement` action reaches the exact successor with no order or stock write. CLAUDE-006 remains manual, read-only, and bound to `b8808439`.
...
1. Complete `ecommerce-replacement-submit-clarity`: make changed checkout say it replaces the current request before submission, retain exact lineage, and prove the wording on mobile and desktop without a business write.
