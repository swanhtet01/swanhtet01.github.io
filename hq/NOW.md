...
- Product outcome gates pass. OPS-241 carries successful physical-location setup directly into the existing reviewed business/location form with canonical stock context and zero automatic accounting write. Next: `shop-location-review-to-first-sale-client-acceptance`; pilots stay owner-gated.
...
- Codex is sole integrator. OPS-241 at `09518535` opens and focuses the existing Shop location review after stock setup, prefills `LOC-MAIN`, and leaves confirmation human-controlled. CLAUDE-008 stays manual at `969fae03`.
...
1. Complete `shop-location-review-to-first-sale-client-acceptance`: after the founder confirms business/location, return to the existing Sell task with frozen scope visible and no automatic sale, payment, or stock write.
