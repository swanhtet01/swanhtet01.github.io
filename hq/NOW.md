...
- OPS-273 (`94bcb195`) stores one fresh-owner authorization for exactly one future Spa invitation attempt. Consumption is mandatory, retry is forbidden, and no provider request or membership occurs. Completion history: 121. Next: guarded transport and isolated mobile proof.
...
- Codex is sole integrator. The 18-file, 56-check PostgreSQL 17 rehearsal passes at `94bcb195`; hosted invitation, activation, and mobile acceptance remain owner-gated. CLAUDE-009 remains owner-controlled.
