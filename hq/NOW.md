...
- 25 recoveries and all 32 Shop/16 Plant final actions pass. Plant next-action and imported Job ID focus pass desktop/mobile. Next: `plant-job-import-ready-row-review`; pilots stay owner-gated.
...
- Codex is sole integrator. OPS-216 opens Add job and focuses JOB-AI-101 after reviewed sample/CSV import; browser QA created no job. CLAUDE-007 stays manual at `2744b28f`.
...
1. Complete `plant-job-import-ready-row-review`: retain and review every valid imported row without re-uploading.
