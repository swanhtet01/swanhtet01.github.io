...
- Ally: `supermega.ally-working-set-trim.v1` previews a verified Codex tree; a 1,516.7 MB trim moved RAM from 83.4% to 80.7%, eligible dispatch, and no process stops.
