...
- 25 recoveries and exact final actions for all 32 Shop plus 16 Plant action kinds pass. Plant Today and governed Shop-demand planning now land on their exact Plant fields on desktop and mobile. Next: `plant-shop-demand-covered-job-open`; pilots stay owner-gated.
...
- Codex is sole integrator. OPS-214 makes governed Shop-demand selection open Add job and focus its populated Job ID instead of the CSV upload on desktop and mobile. Historical local receipts remain digest-bound outside the hot portfolio without weakening duplicate-work rejection. CLAUDE-007 remains a manual read-only review of exact checkpoint `2744b28f`.
...
1. Complete `plant-shop-demand-covered-job-open`: make the existing `Open JOB` action visibly open and focus the covered Plant job.
