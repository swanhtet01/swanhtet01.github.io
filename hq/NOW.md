...
- 25 recoveries and all 32 Shop/16 Plant final actions pass. Exact Plant next-action focus passes desktop/mobile. Next: `plant-job-import-ready-focus`; pilots stay owner-gated.
...
- Codex is sole integrator. OPS-215 opens and focuses the exact existing Plant job on desktop/mobile. The seed lacked a covered card, so QA used source-bound JOB-201 without creating data. CLAUDE-007 stays manual at `2744b28f`.
...
1. Complete `plant-job-import-ready-focus`: focus populated Job ID after sample or CSV review.
