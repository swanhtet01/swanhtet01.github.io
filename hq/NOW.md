...
- Plant maintenance binds active strategy, projects due work, and requires structured reviewed completion outcome, findings, procedure confirmation, and return recommendation. It performs no dispatch, control, telemetry, status, or parts action.
...
- The current candidate passes 379 Python, 274 Production, 318 Kernel, 69 connector, and 15 crew checks. Headless Edge verifies Plant maintenance at desktop and 390 px without overflow or runtime errors.
